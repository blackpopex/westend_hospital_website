...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="All the medical services provided at Westend Hospital Warri are listed from A to Z.
                  ...
                  <ul class="flex navBar1">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-content" id="menuDropdown">
                        <li>
                          <a href="A-Z-of-all-medical-test.html"
                            >A-Z of all Medical Test</a
                          >
                        </li>
                        <li>
                          <a href="A-Z-of-all-medical-services.html"
          ...
          <section id="c" class="test-names-by-aphabets">
            <div class="flex test-list">
              ...
              <ul>
                ...
                <li>
                  <a href="#/"
                    >Central Visual Field (Twice A Year For Glaucoma)</a
                  >
                </li>
          ...
          <section id="f" class="test-names-by-aphabets">
            <div class="flex test-list">
              ...
              <ul>
                ...
                <li>
                  <a href="#/"
                    >Foreign Body Removal in the ear without Sedation</a
                  >
                </li>
                <li>
                  <a href="#/"
                    >Foreign Body Removal in the Nose with Sedation</a
                  >
                </li>
                <li>
                  <a href="#/"
                    >Foreign Body Removal in the Nose without Sedation</a
                  >
                </li>
          ...
          <section id="o" class="test-names-by-aphabets">
            <div class="flex test-list">
              ...
              <ul>
                ...
                <li>
                  <a href="#/"
                    >Ophthalmologist Consultation (Once Per Quarter)</a
                  >
                </li>
          ...
          <section id="s" class="test-names-by-aphabets">
            <div class="flex test-list">
              ...
              <ul>
                ...
                <li>
                  <a href="#/"
                    >Slow Infiltration with Depo Medrol/ Xylocaine/
                    Adrenaline</a
                  >
                </li>
