...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Early childhood is when behavioral disorders initially manifest, and they are quite common in children. Nevertheless, odd behavior is not always a sign of a mental health problem. It is advised that parents take their children for a mental health evaluation because of this. "/>
        <meta charset="UTF-8"/>
                    ...
                    <div
                        ...
                        <div class="column-right col-70">
                            <div class="margin-bottom">
                                ...
                                <p>The way a person behaves in response to specific stimuli or circumstances may be summed up in one word: behavior. It consists of one's actions in a social setting. The way a person handles things and interacts with others should be considered when evaluating behavior.</p>
                                <p>Behavior disorders first appear in early childhood and are quite prevalent in kids. Although behavioral abnormalities do not always indicate that a person has a mental health issue. This is why it is suggested that parents take their kids for a mental health evaluation.</p>
                            ...
                            <div class="margin-bottom">
                               <div class="margin-bottom">
                                ...
                                <p>Different things can lead to behavioral disorders. Biological, familial, and educational variables can all be linked to the abnormal behavior that is typically associated with these illnesses.</p>
                               ...
                               <div class="margin-bottom">
                                ...
                                <p>A behavioral issue that is not addressed can have detrimental short- and long-term implications on a person's personal and professional life. People may be suspended or expelled for misbehaving, such as when they fight, bully, or argue with authorities. At some point, adults might lose their jobs. Long-term strained relationships have the potential to destroy marriages.</p>
                                </div>
                               ...
                               <ul class="square-list-type margin-bottom" id="squareList">
                                 ...
                                 <p>OCD as being characterized by anxieties and unreasonable ideas that result in obsessions and compulsions. When you have OCD, you continue to act in a compulsive, repetitive manner despite being aware of the unfavorable effects or even the unreasonableness of your behavior. Nothing more than a temporary stress reduction is achieved by performing these repetitious actions.</p>
                                 <p>Get help as soon as you can if you or a loved one is struggling with any of these behavioral disorders because they can hurt your quality of life and even induce self-harm. </p>
                                </div>
                            </div>
                        </div>
