...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
            content="Dysthymia is just another word for depression, so don't let the complex phrase fool you.This psychological and behavioral disorder involves chronic depression. " />
        <meta charset="UTF-8" />
                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70">
                            <div class="margin-bottom">
                                ...
                                <p>Do not be misled by the difficult term dysthymia; it is simply another name for
                                    depression. Chronic depression is what this mental and behavioral condition entails.
                                </p>
                                <p>It's possible for persistent depressive disorder(PDD) victims to feel hopeless,
                                    unhappy, devastated, or even depressed. They quickly lose interest in activities,
                                    and this affects how well they do overall. PDD frequently ruins social gatherings,
                                    job relationships, and interpersonal connections.</p>
                                <p>Patients with PDD struggle to feel cheerful and find it very challenging to become
                                    enthused by anything; they lose themselves in melancholy and are unable to take part
                                    in any activities or happy settings.</p>
                                <p>They naturally grumble frequently, are perpetually pessimistic, and are continually
                                    miserable. Although the patient is only mildly unhappy and not excessively so, the
                                    illness is similar to major depression even if it is less severe. Because major
                                    depression is so severe, it needs to be properly treated.</p>
                                <p>It can be particularly challenging to manage depression symptoms because of the
                                    persistent nature of the persistent depressive disorder.</p>
                            </div>
                            <div class="margin-bottom">
                                <h6 class="sky-blue">Identifying the PDD</h6>
                                <p>The following symptoms can be used to determine if someone has chronic depression.
                                </p>
                                ...
                                <p>It is crucial to remember that PDD symptoms might last for months, although PDD
                                    episodes come and go over the years and can change over time depending on their
                                    intensity. Additionally, it causes depression and irritability in kids.</p>
                            </div>

                            <div class="margin-bottom">
                                <h6 class="sky-blue">Consult a physician</h6>
                                <p>You only need to ask for assistance, so don't be scared. With your effort and
                                    indulgence in the appropriate activities, the illness can be addressed and is not a
                                    lifelong disorder.</p>
                                <p>It's impossible to resist feeling angry, frustrated, or uneasy because these feelings
                                    are universal and quite natural. Understanding this will help you increase your
                                    chances of healing.</p>
                                <p>Additionally, discuss your symptoms with a primary care physician. You can also get
                                    in touch with knowledgeable, seasoned mental health professionals. Reach out to a
                                    trusted friend, loved one, or even your instructor or lecturer, a religious leader,
                                    or someone trustworthy if access to the aforementioned methods is not possible.</p>
                                <p>Please call Westend Hospital (+234807 420 2395), if you don't have anyone you can
                                    turn to, if you're worried you might hurt yourself, or if your life is in danger.
                                </p>
                            </div>
                            <div class="margin-bottom">
                                <h6 class="sky-blue">Reasons for PDD</h6>
                                <p>The cause of PDD is yet unknown to science. However, research indicates that given
                                    the significant role depression plays in it, it is safe to assume that the following
                                    factors may contribute to its occurrence:</p>

                                <ul class="square-list-type" id="squareList">
                                    <li><b class="sky-blue">Genetic factors:</b> People with blood relatives who also
                                        have persistent depression appear to have the condition more frequently.</li>
                                    <li><b class="sky-blue">Life experience:</b> Trauma, which includes the loss of a
                                        loved one, financial hardship, impoverishment, and even a high level of stress,
                                        is strongly associated with major depression.</li>
                                </ul>
                            </div>
                            ...
                            <div class="margin-bottom">
                                ...
                                <ul class="square-list-type" id="squareList">
                                    <li>Avoid being alone by surrounding yourself with loved ones, and by having a
                                        support system; it is simpler to seek assistance when needed.</li>
                                    <li>Get long-term maintenance treatment during the rehabilitation process to help
                                        prevent a symptom return.</li>
