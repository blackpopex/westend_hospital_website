...
<html lang="en">
    ...
    <head>
        <title>
            Phobias | Westend Hospital
        </title>
        <link rel="icon" type="image/x-icon" href="../../img/logo/favicon.ico.png" />
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css" />
        <meta name="description"
            content="An anxiety disorder known as a phobia is characterized by an extreme, ongoing fear of a stimuli or situation. As a result, fear immediately begins to set in." />
        <meta charset="UTF-8" />
                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70">
                            <div class="margin-bottom">
                                <h3 class="navy-blue">Phobias</h3>
                                <p>A phobia is an anxiety disorder marked by a persistent, overwhelming fear of a
                                    stimulus or circumstance. Fear quickly starts to set in as a result.</p>
                                <p>Fears are more subtle than phobias. They emerged when a person had an exaggerated or
                                    irrational feeling of danger about a particular item or circumstance.</p>
                            </div>
                            <div>
                                <h4 class="navy-blue">Types of phobias</h4>
                            </div>
                            <div class="margin-bottom">
                                <div class="margin-bottom">
                                    <h6 class="sky-blue">Specific phobia</h6>
                                    <p>Put simply, these are phobias that are related to the fear of a specific
                                        situation. A subset of specific phobias includes the following: Environment
                                        type, blood infection type, injury type, circumstance type, and other forms of
                                        phobias that don't fall within the categories listed above. Most phobia victims
                                        are aware that their fear is unfounded. However, when they are exposed to their
                                        phobia, they will feel intense anxiety. Typically, childhood and adolescence are
                                        stages in one’s life when phobias first appear. While this may not always hold,
                                        it is a common observation that phobias get milder as people mature.</p>
                                </div>
                                <div class="margin-bottom">
                                    <h6 class="sky-blue">Social phobias</h6>
                                    <p>This is a type of phobia where an individual dread’s being in social situations
                                        that could put one in a humiliating or embarrassing position. Situations like
                                        public speaking contests, spelling bees, and other competitions may trigger this
                                        anxiety.</p>
                                </div>
                                <div class="margin-bottom">
                                    <h6 class="sky-blue">Agoraphobia</h6>
                                    <p>People with this type of phobia are typically introverts who become housebound
                                        because they don't want to leave their comfort zones. Agoraphobia is the fear of
                                        being in public places or crowded places without an easy means of escaping.</p>
                                </div>
                            </div>
                            ...
                            <ul class="square-list-type" id="squareList">
                                <li>A traumatic or unfortunate event</li>
                                <li>Early life circumstances and experiences</li>
                                <li>Geneology</li>
                            </ul>

                            <div class="margin-bottom">
                                <p>Symptoms and signs</p>
                                <p>It is recommended that you seek out assistance immediately if you develop the
                                    following symptom; laziness, shakiness, lightheadedness, feeling of deep
                                    perspiration, palpitations or an elevated heart rate, difficulty breathing tremors,
                                    trembling, and uneasy stomach ache.</p>
                            </div>
                            <div class="margin-bottom">
                                <h6 class="sky-blue">Estimated Time</h6>
                                <p>Specific phobias in children can be transient issues that go away in a few months.
                                    About 80% of newly developed phobias in adults progress to chronic (long-term)
                                    illnesses that persist in the absence of effective therapy.</p>
                            </div>
                            <div class="margin-bottom">
                                <h6 class="sky-blue">Prevention</h6>
                                <p>Fear cannot be stopped once it begins. However, treatment can lessen the disorder's
                                    detrimental effects.</p>
                            </div>
                            <div class="margin-bottom">
                                <h6 class="sky-blue">Treatment</h6>
                                <p>Depending on the phobia, the typical course of treatment involves a mix of
                                    psychotherapy and medication. Exposure therapy or desensitization therapy is an
                                    example of psychotherapy.</p>
                                <p>It entails progressively increasing your exposure to the item you fear, at your
                                    speed, in safe surroundings. As you are exposed to the object, you are taught how to
                                    regulate your fear by calming down, controlling your breathing, or using other
                                    anxiety-relieving techniques. Your doctor can suggest an antianxiety drug to cure
                                    phobias temporarily. Medication use can be beneficial if the phobia is only
                                    sporadically triggered, as in the case of a fear of swimming.</p>
                                <p>An individual's phobias may cause them real and enduring pain. However, they are
                                    typically treatable, and the cause of dread is frequently avertable.</p>
                                <p>One thing that people with phobias should never be frightened of is asking for help.
                                </p>
                            </div>
                        </div>
