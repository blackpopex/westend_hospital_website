                        ...
                        <div class="column-right col-70">
                            <div class="margin-bottom">
                                <h3 class="navy-blue">
                                    ...
                                    <div class="margin-bottom">
                                        <p>The medical field of anesthesiology, sometimes known as anesthesia, is concerned with the complete perioperative treatment of patients before, during, and after surgery. It includes anesthesia, critical emergency medicine, intensive care medicine, and pain medicine.</p>
                                        <p>Integrated care before, during, and following surgery is provided to the whole patient route.</p>
                                        <p>The practice of providing patients with patient-centered, interdisciplinary, and integrated medical care from the time they begin to consider having surgery until they have fully recovered is known as perioperative medicine.</p>
                                        <p>The anesthetic care team's job during your operation is to keep your vital organs, such as your heart, blood pressure, and breathing, functioning normalized. Before your operation, you will meet with our anesthesia care team to go through the type of anesthesia that will be used and to go over your prior medical and surgical history.</p>
                                        <p>By assisting patients in avoiding medical issues and encouraging postoperative recovery, our mission is to improve the results of our patient's surgical procedures.</p>
                                    </div>

                                     <div class="department-img-container margin-bottom margin-top">
                                                <img src="../../img/other photos/perioperative.jpg" alt="Patient undergoing anesthesiology and perioperative" id="alignLeft">
                                    </div>

                                    <div class="margin-top margin-bottom">
                                        <h4 class="navy-blue">The department offers a wide range of specialist services, including:</h4>                                       
                                        ...
                                        <p>To ensure that every patient receives high-quality care, we combine professionals with cutting-edge technology.</p>
                                    </div>                                       
                                    <div class="margin-bottom">
                                        <p>We believe that to recover after surgery in the best possible health:</p>                                       
                                         <ul class="square-list-type" id="squareList">
                                            <li>We have to comprehend our patients. This contains their top priorities, health issues, aptitudes, and constraints.</li>
                                            <li>Surgery-related complications should be expected and prepared for.</li>
                                            <li>Throughout their procedure, communication between patients and all of their providers needs to be encouraged.</li>
                                            <li>To spot changes in patient trajectories, improved monitoring systems should be used.</li>
                                        </ul>
                                        <p>From the time surgery is planned until the day the patient resumes their regular activities, we are committed to advancing patient-centered and dependable healthcare.</p>
                                    </div>                                       
