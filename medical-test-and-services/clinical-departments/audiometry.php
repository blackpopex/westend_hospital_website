                        ...
                        <div class="column-right col-70">
                            <div class="margin-bottom">
                                <h3 class="navy-blue">
                                    ...
                                    <div class="margin-bottom">
                                        <p>Westend infirmary Healthcare professionals known as audiologists diagnose, evaluate, and treat abnormalities of the hearing, balance, and other neurological systems. Finding and evaluating abnormalities of hearing, balance, and related functions are the focus of audiology.</p>
                                         <div class="department-img-container margin-bottom margin-top">
                                            <img src="../../img/other photos/audiometry.jpg" alt="Audiology investigation" id="alignLeft">
                                        </div>
                                        <p>As part of our team orientation, we work with patients of all ages, advising and supplying suitable therapy care and rehabilitation. We provide rehabilitation services for hearing loss, balance and dizziness issues, tinnitus, and hyperacusis in addition to having a full-service dispensing program for hearing aids and assistive listening devices (extreme sound sensitivity).</p>
                                    </div>
                                    <div class="margin-top margin-bottom">
                                        ...
                                        <ul class="square-list-type margin-bottom" id="squareList">
                                            <li>Comprehensive audiological hearing assessments for the diagnosis, monitoring, preservation, and management of hearing loss.</li>
                                            <li>Full vestibular and balance evaluations.</li>
                                            <li>Comprehensive audiological rehabilitation services that make it easier to use hearing that has been lost or restored and employ technology to improve communication with others.</li>
                                        </ul>
                                        <p>Within the south-south, Westend Hospital is one of the top hospitals for treating ear, nose, and throat conditions.</p>
                                    </div>  
                                    <div class="margin-top margin-bottom">
                                        ...
                                        <ul class="square-list-type" id="squareList">
                                            ...
                                            <li>Testing with a real ear probe microphone and electroacoustic analysis of hearing aids.</li>
                                    ...
                                    <div class="margin-bottom">
                                        ...
                                        <p>Not all hearing issues are immediately apparent. Children may experience many types and degrees of hearing impairment.For instance, even if a youngster may react to some sounds in the house, they might not be able to hear everything, like the sound of a door opening or a key turning in a lock. To prevent any impact on a kid's capacity to develop strong speech and language abilities as well as to offer the child and their parents help and information, issues must be identified as early as feasible.</p>
                                        <p> Adult hearing loss or trouble hearing in noisy environments can restrict a person's participation in social and professional activities. They become aware of the problem when they have trouble hearing in noisy places, around other people, or while talking on the phone.</p>
                                       
                                    </div> 
                                    <div class="margin-bottom">
                                        <h4 class="navy-blue">What do we hope to accomplish?</h4>
                                         <p>The goal of the audiology team at Westend is to actively engage adults in decisions about how to manage their hearing loss to enhance their quality of life.</p>
                                    </div>                                         
