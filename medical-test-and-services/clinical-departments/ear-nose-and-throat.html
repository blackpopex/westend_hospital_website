...
<html lang="en">
    <head>
        ...
        <meta name="description" content="The ears, nose, and throat are the main areas of interest in the medical field of otolaryngology."/>
        <meta charset="UTF-8"/>
                        ...
                        <div class="column-right col-70 ">
                            <div class="margin-bottom">
                                <h3 class="navy-blue">
                                    ...
                                    <div class="margin-bottom">
                                        <p>The ears, nose, and throat are the main areas of interest in the medical field of otolaryngology. Because specialists are trained in both medicine and surgery, it is also known as otolaryngology-head and neck surgery. An ENT, or ear, nose, and throat physician is another name for an otolaryngologist.</p>
                                                    ...
                                                    <div class="col-30">
                                                        <div class="conditions-wrapper ear-orange_border">
                                                            <div class="condition-desc">
                                                                ...
                                                                <p>Ear infections, Tinnitus, and ringing in your ears can be the result of loud noises or medicines. Ear barotrauma is an injury to your ear due to insufficient equilibration of the middle ear.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-30">
                                                        <div class="conditions-wrapper throat-pink_border">
                                                            <div class="condition-desc">
                                                                ...
                                                                <p>Inflammation is a primary cause of throat pain. The reason could be allergies, strep infection, GERD, or tonsillitis. Hoarseness or voice loss is caused by Laryngitis(swelling of the voice box).</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-30">
                                                            <div class="conditions-wrapper nose-blue_border">
                                                                ...
                                                                <p>Soft growths that form on the sinus or nasal mucosa are known as nasal polyps. Rhinitis is an allergy-related inflammation of the nose and sinuses. A runny nose is the main sign. </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                               </div>
                                    ...
                                    <div class="margin-top margin-bottom">
                                        <p>The ear, nose, and throat perform important tasks and are some of the basic bodily processes that make life so full and lovely. However, life is hampered or even endangered when one or more of these processes stop functioning as they should.</p>

                                    </div>

                                    <div class="margin-top margin-bottom">
                                    <p>Some of the conditions that Westend's Hospital "ENT" (ear, nose, and throat) experts treat include:</p>  
                                    ...
                                    <div class="margin-bottom">
                                        ...
                                        <p>There may be a variety of factors that make an ENT appointment necessary for you. The body parts most likely to be impacted by a condition that an ENT physician can treat are those listed below:</p>

                                        <ul class="square-list-type" id="squareList">
                                            <li><b class="sky-blue">Nose (rhinology): </b>Nose-related crises such as allergies, sinus headaches, migraines, deviated septum, and reduction of the enlarged turbinate. </li>
                                            <li><b class="sky-blue">Otology/neurotology of the ears: </b> Not just in terms of hearing, but also about balance, our ears play a critical function in a healthy body. Many ear problems, such as hearing loss and ringing (Tinnitus) in the ears.</li>
                                            <li><b class="sky-blue">Throat (laryngology):</b>Issues with the airways or painful throats (laryngology) diseases like gastroesophageal reflux disease, as well as issues with the airways or sore throats.</li>
                                            <li><b class="sky-blue">Face: </b>The change or discomfort in the face could be the result of something like a congenital defect or a side effect of another medical disease, changes in facial appearance brought on by trauma or injury.</li>
                                            <li><b class="sky-blue">Neck and head:  </b>ENT physicians may provide care for this vital area of the body, which contains several of the most vital organs, including dealing with enlarged thyroid glands.</li>
                                            <li><b class="sky-blue">Snoring:  </b>Snoring issues, as well as disorders like sleep apnoea, which may have a serious impact, are other reasons why many people schedule an appointment at our ENT clinic.</li>
                                           
                                        </ul>
                                    </div>
                                    <div class="margin-bottom">
                                        <h4 class="navy-blue">Services rendered at our ENT department</h4>
                                        <p>You will be seen by one of the best otolaryngologists when you schedule a visit at Westend Hospital's ear, nose, and throat (ENT) clinic. These professionals will figure out the cause of any problems you or your loved ones may be experiencing, whether they have to do with sleep, sinus and allergy issues, breathing, swallowing, hearing, or balancing. In the primary care setting, our team of experts presides over ENT-related issues that are present in about 50% of patients. Westend’s Otolaryngologists are specialized consultants who can diagnose you, create a treatment plan for you, and carry out delicate operations, such as removing tumors or regaining hearing and reconstructing of tympanic membrane.</p>
                                        <div class="margin-bottom">
                                    ...
                                    <h4 class="navy-blue margin-top scheduling-heading">Otolaryngology Central Scheduling</h4>
                                    <div class="scheduling margin-bottom">
                                        <ul>
                                            <li><span class=" fa fa-phone-alt navy-blue"></span> +234 (0) 807 419 8678</li>
                                            <li><span class="fa fa-envelope navy-blue"></span> <a href="mailto:ent@thewestendhospital.com">ent@thewestendhospital.com</a></li>
                                        </ul>
                                    </div>
