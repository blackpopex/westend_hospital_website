...
<html lang="en">
    <head>
        <title>
           Emergency Department - Clinical Department | Westend Hospital</title>
        <link rel="icon" type="image/x-icon" href="../../img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="WOur highly qualified medical staff is ready 24/7 to examine patients, provide diagnoses, and deliver treatments.
        Whether you are experiencing severe injuries, a stroke, or chest or abdominal pain, your care is our top focus."/>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <main>
            <div class="section-background-image departments-and-services">
                <div class="container">
                    <h2 class="subnavbar-color">Emergency Department</h2>
                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70 welcome-text">
                            <div class="margin-bottom">
                                <h3 class="navy-blue">
                                    Welcome to Emergency Department</h3>
                                    <div class="margin-bottom">
                                        <p>Any emergency in your family? Our expert medical professionals are available around-the-clock to assess patients, make diagnoses, and administer treatments. Your care is our main priority, whether it involves chest or abdominal pain, stroke, or catastrophic injuries.</p>
                                        <p>It might be difficult to determine which medical issues call for an Emergency Room (ER) visit. Sometimes, the best course of action is to visit your primary care physician or a nearby urgent care facility e.g Westend hospital.</p>        
                                    </div>

                                    <div>
                                        <p>Our emergency rooms are equipped to handle a wide range of urgent situations, including:</p>
                                           <div class="flex align-start">
                                               <ul class="square-list-type col-50" id="squareList">
                                                <li>Continent pain.</li>
                                                <li>Chest pressure or discomfort.</li>
                                                <li>Dehydration.</li>
                                                <li>Breathing Issues.</li>
                                                <li>Broken bones and fractures.</li>
                                                <li>Injury to the head or neck.</li>
                                                <li>Loss of blood.</li>
                                                <li>Persistent or high fevers.</li>                                  
                                                                                       </ul>
                                               <ul class="square-list-type col-50" id="squareList">
                                                <li>Loss of consciousness.</li>
                                                <li>Vehicle collision injuries.</li>
                                                <li>Poisoning.</li>
                                                <li>Stroke.</li>
                                                <li>Virulent infections.</li>
                                                <li>Paralysis, seizures, or sudden, severe headaches.</li>
                                                <li>Burns.</li>
                                                                                       </ul>
                                           </div>
                                    </div>
                                    ...
                                    <div class="margin-bottom margin-top">
                                        <p>Our group of emergency personnel consists of qualified medical doctors, licensed nurses, and skilled personnel.</p>
                                        <p>We provide emergency medical care to anyone in need, seven days a week, around-the-clock.
Nobody plans to visit the emergency room, but if one does, you can be sure that Westend hospital emergency room will take care of you, no matter where in the neighborhood you call home.
</p>
                                    </div>

                                    <div class="margin-top margin-bottom">
                                        <h4 class="navy-blue">Outstanding Emergency Care</h4>
                                        <p>We are an integrated platform for providing timely, high-quality healthcare services for people with acute illnesses and injuries throughout their lives.</p>
                                        <p>To connect these undifferentiated patients to the urgent treatment they require, our emergency care systems support components of health system that are integrated. We are made up of more than just components, infrastructure, and laborers. To deliver care in an orderly manner and without delay, the successful management of time-sensitive conditions also necessitates the establishment of certain rules and processes in advance, and that is precisely what we provide.</p>
                                       
                                    </div>                                          
                                    <div class="light-grey-border"></div>
                                    <h4 class="navy-blue margin-top scheduling-heading">Emergency Central Scheduling</h4>
                                    <div class="scheduling margin-bottom">
                                        <ul>
                                            <li><span class=" fa fa-phone-alt navy-blue"></span> +234 (0) 905 376 4762</li>
