...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
            content="WOur highly qualified medical staff is ready 24/7 to examine patients, provide diagnoses, and deliver treatments.
                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70 welcome-text">
                            <div class="margin-bottom">
                                ...
                                <div class="margin-bottom">
                                    <p>Any emergency in your family? Our expert medical professionals are available
                                        around-the-clock to assess patients, make diagnoses, and administer treatments.
                                        Your care is our main priority, whether it involves chest or abdominal pain,
                                        stroke, or catastrophic injuries.</p>
                                    <p>It might be difficult to determine which medical issues call for an Emergency
                                        Room (ER) visit. Sometimes, the best course of action is to visit your primary
                                        care physician or a nearby urgent care facility e.g Westend hospital.</p>
                                </div>

                                <div>
                                    <p>Our emergency rooms are equipped to handle a wide range of urgent situations,
                                        including:</p>
                                ...
                                <div class="margin-bottom margin-top">
                                    <p>Our group of emergency personnel consists of qualified medical doctors, licensed
                                        nurses, and skilled personnel.</p>
                                    <p>We provide emergency medical care to anyone in need, seven days a week,
                                        around-the-clock.
                                        Nobody plans to visit the emergency room, but if one does, you can be sure that
                                        Westend hospital emergency room will take care of you, no matter where in the
                                ...
                                <div class="margin-top margin-bottom">
                                    ...
                                    <p>We are an integrated platform for providing timely, high-quality healthcare
                                        services for people with acute illnesses and injuries throughout their lives.
                                    </p>
                                    <p>To connect these undifferentiated patients to the urgent treatment they require,
                                        our emergency care systems support components of health system that are
                                        integrated. We are made up of more than just components, infrastructure, and
                                        laborers. To deliver care in an orderly manner and without delay, the successful
                                        management of time-sensitive conditions also necessitates the establishment of
                                        certain rules and processes in advance, and that is precisely what we provide.
                                    </p>
