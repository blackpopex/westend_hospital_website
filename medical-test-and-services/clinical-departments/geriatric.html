...
<html lang="en">
    <head>
        <title>
            Geriatric - Clinical Department | Westend Hospital </title>
        <link rel="icon" type="image/x-icon" href="../../img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="The study of geriatrics, also referred to as geriatric medicine, is aimed at improving the treatment of elderly patients.
        By avoiding and treating the illness and damage that usually occur with aging, it aids in older people becoming healthier. "/>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <main>
            <div class="section-background-image departments-and-services">
                <div class="container">
                    <h2 class="subnavbar-color">Geriatric</h2>
                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70 welcome-text">
                            <div class="margin-bottom">
                                <h3 class="navy-blue">
                                    Welcome to Department of Geriatric</h3>
                                    <div class="margin-bottom">
                                        <p>Geriatrics, often known as geriatric medicine, is a field of study focused on enhancing aged patient care. It helps older persons become healthier by preventing and treating the sickness and impairment that frequently accompany aging. </p>
                                        <p>Through patient treatment, Westend Hospital's division of geriatric medicine works to encourage healthy aging. Your needs for medical care change as your body matures hence it's crucial to work with a doctor who has received specialized training in maintaining the health of senior citizens. Geriatric medicine, however, is not simply for the elderly and fragile. Our doctors are experts at assisting healthy, active "middle-aged adults" in making a smooth transition into their 60s and maintaining good health into old age.</p>
                                    </div>

                                     <div class="department-img-container margin-bottom margin-top">
                                        <div class="flex">
                                                <img src="../../img/other photos/Geriatric.jpg" alt="Old women laughing">
                                                <div class="img-side-text">
                                                    <h4 class="navy-blue">Geriatric & Ageing</h4>
                                                    <p class="text-black text-bold">At Westend Hospital, we understand the importance of caring for the erderly.</p>
                                                </div>
                                            </div>
                                    </div>

                                    <div class="margin-top margin-bottom">
                                        <h4 class="navy-blue">The following are important aspects of delivering geriatric care: </h4>                                       
                                         <ul class="square-list-type" id="squareList">
                                            <li>Early detection of serious illness.</li>
                                            <li>Keeping a current health issue from getting worse.</li>
                                            <li>Making patients understand how to manage their disease conditions.</li>
                                        </ul>
                                    </div>                                          
                                    <div class="margin-top margin-bottom">
                                        <h4 class="navy-blue">These five principles are kept in mind when we provide care for senior citizens:</h4>                                       
                                         <ul class="square-list-type" id="squareList">
                                            <li>Aligns care across all care settings with each patient's unique outcomes goals, putting the patient's needs first.</li>
                                            <li>Delirium is prevented, recognized, treated, and managed in all care settings.</li>
                                            <li>Follows prescription guidelines that don't conflict with the patient's health.</li>
                                            <li>Making sure each patient remains healthy to preserve the function needed to do "What Matters."</li>
                                            <li>Managing debilitating conditions</li>
                                        </ul>
                                    </div>                                          
                                    <div class="margin-top margin-bottom">
                                        <p>At Westend Hospital, we think about the needs and preferences of the patient by </p>                                       
                                         <ul class="square-list-type" id="squareList">
                                            <li>Being compassionate, understanding, and nice to our patients. We are kind to one another and respect one another's emotions when communicating.</li>
                                            <li>Encouraging independence in making decisions for oneself by supporting their decision-making abilities.</li>
                                            <li>Aiding people in developing emotional stability by overcoming emotional restraint and communicating with their loved ones.</li>
                                            <li>Improving your happiness, self-esteem, and confidence, stimulate your cerebral acuity, sensory input, and physical exercise.</li>
                                            <li>Making the patient's home feel comfortable for the elderly. Assist them in continuing to engage actively and joyfully with their family.</li>
                                            <li>Upholding your privacy. Making our patients feel secure and at ease so they may discuss their emotional and physical needs openly.</li>
                                        </ul>
                                    </div>                                          
                                    <div class="margin-top margin-bottom">
                                            <p>Our objective is to develop thorough geriatric care plans that are intended to maintain patients' independence and enhance their quality of life.  </p>
                                     </div>                                  
                                   
                                        
                                                                           
                                    <div class="light-grey-border"></div>
                                    <h4 class="navy-blue margin-top scheduling-heading">Geriatric Central Scheduling</h4>
                                    <div class="scheduling margin-bottom">
                                        <ul>
                                            <li><span class=" fa fa-phone-alt navy-blue"></span> +234 (0) 807 420 2395</li>
                                            <li><span class="fa fa-envelope navy-blue"></span> <a href="mailto:medical@thewestendhospital.com">medical@thewestendhospital.com</a></li>
                                        </ul>
                                    </div>
