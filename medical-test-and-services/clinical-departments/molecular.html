...
<html lang="en">
    <head>
        <title>
           Molecular Diagnostic Laboratory - Clinical Department | Westend Hospital</title>
        <link rel="icon" type="image/x-icon" href="../../img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="By offering a wide variety of state-of-the-art molecular diagnostics and precision medicine assays, our molecular diagnostics laboratory empowers life at the molecular level."/>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <main>
            <div class="section-background-image departments-and-services">
                <div class="container">
                    <h2 class="subnavbar-color">Molecular Laboratory</h2>
            ...
            <section id="Molecular_Laboratory">
                    ...
                    <div class="flex">
                            ...
                            <aside>
                                ...
                                <div class="column-left">
                                    ...
                                    <div class="quick-links department-quicklinks">
                                        ...
                                        <ul class="accordion-content" id="menuDropdown">
                                            <li><a href="/medical-test-and-services/patient-support-services/account.html">Account</a></li>
                                            <li><a href="/medical-test-and-services/patient-support-services/client-relations.html">Client Relations</a></li>
                                            <li><a href="/medical-test-and-services/patient-support-services/insurance.html">Insurance</a></li>
                                            <li><a href="/medical-test-and-services/patient-support-services/medical-records.html">Medical Record</a></li>
                                            <li><a href="/medical-test-and-services/patient-support-services/nursing.html">Nursing</a></li>
                                            <li><a href="/medical-test-and-services/patient-support-services/occupational-health.html">Occupational Health</a></li>
                                            <li><a href="/medical-test-and-services/patient-support-services/out-patient-department.html">Out Patient Department</a></li>
                                            <li><a href="/medical-test-and-services/patient-support-services/supermart.html">Supermart</a></li>
                                            <li><a href="/medical-test-and-services/patient-support-services/cafeteria.html">Cafeteria</a></li>
                                            <li><a href="/medical-test-and-services/patient-support-services/security.html">Security</a></li>
                        ...
                        <div class="column-right col-70 welcome-text">
                            <div class="margin-bottom">
                                <h3 class="navy-blue">
                                    Empowering Lives on a Molecular Level</h3>
                                    <div class="margin-bottom">
                                        <p>The development and execution of molecular diagnostic assays for nucleic acid targets present in a range of medical contexts is the responsibility of the Molecular Diagnostics Laboratory.</p>
                                        <p>We provide a broad range of cutting-edge molecular diagnostics and precision medicine assays.</p>                                              
                                    </div>

                                      <div class="department-img-container margin-bottom">
                                            <div class="col-100">
                                                <img src="../../img/other photos/dna-photo.jpg" alt="deoxyribonucleic acid">
                                            </div>        
                                       </div>

                                    <div class="margin-bottom">  
                                        <p>We believe that everyone should have access to improved decision-based healthcare and diagnostics, hence we created our lab to be unique because of this.</p>
                                        <p>To empower lives at the molecular level is the common goal shared by all of our partners, clients, and team members.</p>
                                    </div>

                                    <div class="margin-bottom"> 
                                        <h4 class="navy-blue">Services</h4> 
                                        <p>Find out more about our testing services. Please get in touch with us if you can't locate what you're searching for so we can see what kind of options we have available.</p>
                                        <p><b>Our Molecular Laboratory can test for:</b></p>
                                        <div class="flex align-start dont-invert-column">
                                            <div class="col-30">
                                            ...
                                            <div class="col-30">
                                             <ul class="square-list-type" id="squareList">
                                                ...
                                                <li>PCR Dengue</li>                                           
                                                <li>PCR for TB</li>                                           
                                                <li>PCR Viral Loads</li>                                           
                                                <li>PCR HR-HPV</li>                                           
                                                <li>PCR Malaria</li>                                           
                                                <li>PCR MTB- CSF, Sputum, Swab, Tisssue and Urine</li>                                           
                                            </ul>
                                            </div>
                                            <div class="col-30">
                                             <ul class="square-list-type" id="squareList">
                                                <li>PCR Peritonial Fluid</li>                                           
                                                <li>PCR Haemophilus Influenza</li>                                           
                                                <li>PCR Zika Virus</li>                                           
                                                <li>& Many More</li>                                           
                                            </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="margin-bottom margin-top">  
                                        <h4 class="navy-blue">Opening Times</h4> 
                                        <div>
                                            <p style="margin-bottom: 0;"><b>Monday to Saturday</b></p>
                                            <p >8:00am - 5:00pm </p>
                                        </div>
                                        <div>
                                            <p style="margin-bottom: 0;"><b>Sunday</b></p>
                                            <p >12:00pm - 5:00pm</p>
                                        </div>
                                    </div>
                            </div>
                              <div class="light-grey-border"></div>
                                    <h4 class="navy-blue margin-top scheduling-heading">Molecular Laboratory Scheduling</h4>
                                    <div class="scheduling margin-bottom">
                                        <ul>
                                            <li><span class=" fa fa-phone-alt navy-blue"></span> +234 (0) 905 376 4745</li>
                                            <li><span class="fa fa-envelope navy-blue"></span> <a href="mailto:molecular@thewestendhospital.com">molecular@thewestendhospital.com</a></li>
                                        </ul>
                                    </div>
