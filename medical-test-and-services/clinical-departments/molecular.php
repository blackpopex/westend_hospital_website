...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
            content="By offering a wide variety of state-of-the-art molecular diagnostics and precision medicine assays, our molecular diagnostics laboratory empowers life at the molecular level." />
        <meta charset="UTF-8" />
                    ...
                    <div class="flex">
                            ...
                            <aside>
                                ...
                                <div class="column-left">
                                    ...
                                    <div class="quick-links department-quicklinks">
                                        ...
                                        <ul class="accordion-content" id="menuDropdown">
                                            <li><a
                                                    href="/medical-test-and-services/patient-support-services/account">Account</a>
                                            </li>
                                            <li><a
                                                    href="/medical-test-and-services/patient-support-services/client-relations">Client
                                                    Relations</a></li>
                                            <li><a
                                                    href="/medical-test-and-services/patient-support-services/insurance">Insurance</a>
                                            </li>
                                            <li><a
                                                    href="/medical-test-and-services/patient-support-services/medical-records">Medical
                                                    Record</a></li>
                                            <li><a
                                                    href="/medical-test-and-services/patient-support-services/nursing">Nursing</a>
                                            </li>
                                            <li><a
                                                    href="/medical-test-and-services/patient-support-services/occupational-health">Occupational
                                                    Health</a></li>
                                            <li><a
                                                    href="/medical-test-and-services/patient-support-services/out-patient-department">Out
                        ...
                        <div class="column-right col-70 welcome-text">
                            <div class="margin-bottom">
                                ...
                                <div class="margin-bottom">
                                    <p>The development and execution of molecular diagnostic assays for nucleic acid
                                        targets present in a range of medical contexts is the responsibility of the
                                        Molecular Diagnostics Laboratory.</p>
                                    <p>We provide a broad range of cutting-edge molecular diagnostics and precision
                                        medicine assays.</p>
                                </div>
                                ...
                                <div class="margin-bottom">
                                    <p>We believe that everyone should have access to improved decision-based healthcare
                                        and diagnostics, hence we created our lab to be unique because of this.</p>
                                    <p>To empower lives at the molecular level is the common goal shared by all of our
                                        partners, clients, and team members.</p>
                                </div>

                                <div class="margin-bottom">
                                    <h4 class="navy-blue">Services</h4>
                                    <p>Find out more about our testing services. Please get in touch with us if you
                                        can't locate what you're searching for so we can see what kind of options we
                                        have available.</p>
                            ...
                            <div class="scheduling margin-bottom">
                                <ul>
                                    ...
                                    <li><span class="fa fa-envelope navy-blue"></span> <a
                                            href="mailto:molecular@thewestendhospital.com">molecular@thewestendhospital.com</a>
                                    </li>
                                </ul>
                            </div>
