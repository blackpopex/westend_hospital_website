...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
            content="The medical specialty of obstetrics and gynecology (O&G) is dedicated to the treatment of female reproductive organs.
                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70 welcome-text">
                            <div class="margin-bottom">
                                ...
                                <div class="margin-bottom">
                                    <p>Obstetrics and gynaecology (O&G) is a branch of medicine that focuses on the care
                                        of the female reproductive organs. An obstetrician deals mainly with the
                                        management of pregnancy and is responsible for overseeing the labor process
                                        prior to childbirth. A gynaecologist, on the other hand, is involved in the
                                        general health of the female reproductive system. This includes the diagnosis,
                                        treatment, and management of obstetric complications, and comes with a surgical
                                        component. At Westend Hospital, we have an in-house obstetrician and
                                        gynaecologist who oversee the management and care of pregnant women and other
                                        female reproductive organ issues.</p>
                                    <p>
                                        Our goal is to provide comprehensive care for patients from early adolescence
                                        through geriatrics, with a focus on the reproductive system. This includes
                                        routine primary and preventive care for pregnancy and delivery, menopause, and
                                        the medical or surgical treatment of all gynecological disorders.
                                    </p>

                                    <div class="department-img-container margin-bottom margin-top">
                                        <div class="flex">
                                            <img src="../../img/other photos/pregnancy.jpg" alt="A pregnant Woman"
                                                id="alignLeft">
                                ...
                                <div class="margin-top margin-bottom">
                                    ...
                                    <p>The phrase "obstetrical care" refers to the treatment of both simple and complex
                                        pregnancies, as well as labor, delivery, and the postpartum period. Given the
                                        importance of pregnancy to a woman's life, it is crucial to receive the right
                                        medical attention to ensure a successful pregnancy.</p>
                                    <p>A lady should regularly see her doctor when pregnant. Physical examinations,
                                        blood tests, and ultrasounds will be performed at these appointments to track
                                        the baby's growth and development. To make the mother's pregnancy, labor, and
                                        delivery as comfortable and stress-free as possible, our obstetrician and
                                        gynaecologist will also go over the various possibilities for the delivery
                                        procedure.</p>
                                </div>
                                <div class="margin-top margin-bottom">
                                    <h4 class="navy-blue">Surgical Care:</h4>

                                    <p>Gynecology surgery encompasses any surgical treatment involving the uterus,
                                        ovaries, cervix, fallopian tubes, vagina, and vulva as well as the other female
                                        pelvic organs and structures.</p>

                                    <p>There are numerous causes for a woman to require gynecological surgery. If she
                                        has endometriosis, fibroids (benign tumors), ovarian cysts, malignancy, chronic
                                        pelvic pain, pelvic inflammatory disease, uterine prolapse, or unusual bleeding,
                                        she may require medical attention. Permanent birth control can also be achieved
                                        by gynecological surgery.</p>
                                    <p>While many conditions can be treated with medicine, dietary changes, or
                                        non-invasive procedures, at Westend Hospital, we offer a significant spectrum of
                                        gynaecological care. Our operative and preparatory care for gynecologic
                                        procedures are provided as inpatient or outpatient services.</p>
                                </div>


                                <div class="light-grey-border"></div>
                                <h4 class="navy-blue margin-top scheduling-heading">Obstetrics & Gynecology Central
                                    Scheduling</h4>
