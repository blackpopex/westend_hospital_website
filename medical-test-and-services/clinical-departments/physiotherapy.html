...
<html lang="en">
    <head>
        <title>
            Physiotherapy - Clinical Department | Westend Hospital</title>
        <link rel="icon" type="image/x-icon" href="../../img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="Our physiotherapy division provides acute and rehabilitative therapies by providing services including exercise prescription, peripheral joint mobility and manipulation, gliding techniques, and neural mobilization, among others."/>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <main>
            <div class="section-background-image departments-and-services">
                <div class="container">
                    <h2 class="subnavbar-color">Physiotherapy</h2>
                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70">
                            <div class="margin-bottom">
                                <h3 class="navy-blue">
                                    Welcome to the Department of Physiotherapy </h3>
                                    <div class="margin-bottom">
                                        <p>Physical therapy helps people achieve, maintain, and recover their full level of mobility and functional ability during their lives. This involves offering treatments when aging, injury, pain, illness, other medical conditions, or environmental factors pose a hazard to mobility and function. What it means to be healthy is fundamentally based on functional movement.</p>
                                        <p>In the areas of promotion, prevention, treatment, habilitation, and rehabilitation, physical therapy aims to identify and maximize the quality of life and movement potential.</p>
                                        <p>To address the needs of the patient population in outpatient units, inpatient units, and acute care settings, the physiotherapy department at Westend Hospital offers acute and rehabilitation treatments. When necessary, the physiotherapy division offers treatments to both adult and pediatric groups.</p>
                                         <div class="department-img-container margin-bottom margin-top">
                                            <img src="../../img/other photos/physiotherapy-session.jpg" alt="Physiotherapy session with a patient" id="alignLeft">
                                        </div>                                      
                                    </div>


                                    <div class="margin-top margin-bottom">
                                        <h4 class="navy-blue">Physical therapy session with a patient</h4>
                                          <p>All of our physiotherapists perform comprehensive patient evaluations and use an evidence-based approach to treat impairments and disabilities brought on by:​</p>
                                        <ul class="square-list-type" id="squareList">
                                            <li>Intricate trauma.</li>
                                            <li>Muscular-skeletal wounds.</li>
                                            <li>Neurological conditions e.g CVA, TBI, MS, GBS, etc.</li>
                                            <li>Cardiopulmonary conditions e.g Lung Cancer, Pleural effusion, Pneumonia, etc.</li>
                                            <li>A sports injury e.g Menisci tear, Sprain, Strain, etc.</li>
                                            <li>Pelvic floor dysfunction in women: prenatal and postnatal.</li>
                                        </ul>
                                    </div> 
                                    <div>
                                        <p>Physiotherapists operate in a variety of professional settings, from outpatient clinics that assist people who are living independently at home but require therapy for ailments like a sore shoulder or back pain to intensive care units that care for critically ill patients.</p>
                                        <p>To support patients in achieving their personal goals, our team provides a constructive approach to treatment planning and goal setting. Through interprofessional collaboration, we hope to guarantee a quick, secure journey with the greatest patient outcome.</p>
                                    </div> 



                                    <div class="margin-top margin-bottom">
                                        <p>Amongst the services we offer are:​</p>
                                        <ul class="square-list-type" id="squareList">
                                            <li>Exercise prescription.</li>
                                            <li>Joint and soft tissue mobilization techniques</li>
                                            <li>Myofascial release and trigger point release</li>
                                            <li>Gliding methods and neural mobilization</li>
                                            <li>Mobilization and manipulation of peripheral joints</li>
                                            <li>Electrotherapy</li>
                                            <li>Health Education</li>
                                        </ul>
                                        <P>The team has 3 licensed physical therapists</P>
                                    </div>                                                                              
                                    <div class="light-grey-border"></div>
                                    <h4 class="navy-blue margin-top scheduling-heading">Physiotherapy Central Scheduling</h4>
