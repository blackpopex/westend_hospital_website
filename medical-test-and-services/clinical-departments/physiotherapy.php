...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
            content="Our physiotherapy division provides acute and rehabilitative therapies by providing services including exercise prescription, peripheral joint mobility and manipulation, gliding techniques, and neural mobilization, among others." />
        <meta charset="UTF-8" />
                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70">
                            <div class="margin-bottom">
                                ...
                                <div class="margin-bottom">
                                    <p>Physical therapy helps people achieve, maintain, and recover their full level of
                                        mobility and functional ability during their lives. This involves offering
                                        treatments when aging, injury, pain, illness, other medical conditions, or
                                        environmental factors pose a hazard to mobility and function. What it means to
                                        be healthy is fundamentally based on functional movement.</p>
                                    <p>In the areas of promotion, prevention, treatment, habilitation, and
                                        rehabilitation, physical therapy aims to identify and maximize the quality of
                                        life and movement potential.</p>
                                    <p>To address the needs of the patient population in outpatient units, inpatient
                                        units, and acute care settings, the physiotherapy department at Westend Hospital
                                        offers acute and rehabilitation treatments. When necessary, the physiotherapy
                                        division offers treatments to both adult and pediatric groups.</p>
                                    <div class="department-img-container margin-bottom margin-top">
                                        <img src="../../img/other photos/physiotherapy-session.jpg"
                                            alt="Physiotherapy session with a patient" id="alignLeft">
                                    </div>
                                </div>
                                ...
                                <div class="margin-top margin-bottom">
                                    ...
                                    <p>All of our physiotherapists perform comprehensive patient evaluations and use an
                                        evidence-based approach to treat impairments and disabilities brought on by:​
                                    </p>
                                    <ul class="square-list-type" id="squareList">
                                        ...
                                        <li>Cardiopulmonary conditions e.g Lung Cancer, Pleural effusion, Pneumonia,
                                            etc.</li>
                                ...
                                <div>
                                    <p>Physiotherapists operate in a variety of professional settings, from outpatient
                                        clinics that assist people who are living independently at home but require
                                        therapy for ailments like a sore shoulder or back pain to intensive care units
                                        that care for critically ill patients.</p>
                                    <p>To support patients in achieving their personal goals, our team provides a
                                        constructive approach to treatment planning and goal setting. Through
                                        interprofessional collaboration, we hope to guarantee a quick, secure journey
                                        with the greatest patient outcome.</p>
                                </div>
                                ...
                                <h4 class="navy-blue margin-top scheduling-heading">Physiotherapy Central Scheduling
                                </h4>
