                        ...
                        <div class="column-right col-70">
                            <div class="margin-bottom">
                                <h3 class="navy-blue">
                                    ...
                                    <div class="margin-bottom">
                                        <p>Radiology is a branch of medicine that uses imaging technology to diagnose and treat disease. This branch of medicine may be divided into two different areas, diagnostic radiology, and interventional radiology.</p>
                                        <p>At Westend Hospital, we practice diagnostic radiology where we diagnose more than 50,000 patients annually. We use teleradiology for reporting our CT Images and Artificial Intelligence for reporting x-rays by affiliating with Synapsica (An Indian teleradiology company, located in New Delhi, India).</p>
                                    ...
                                    <div class="grid-photo-main-container">
                                        <div class="grid-wrapper">
                                            <img src="../../img/other photos/radiology-department/radiographers.jpg" alt="radiographers" class="grid-item large-grid-item">
                                            <img src="../../img/other photos/radiology-department/450x300/ct-investigation-2.jpg" alt="ct-investigation-2" class="grid-item">
                                             <img src="../../img/other photos/radiology-department/450x300/CT-Machine.jpg" alt="CT-Machine" class="grid-item">
                                           
                                            <img src="../../img/other photos/radiology-department/450x300/ultrasound-2.jpg" alt="ultrasound-2" class="grid-item">
                                            <img src="../../img/other photos/radiology-department/450x300/x-ray.jpg" alt="x-ray" class="grid-item">
                                             <img src="../../img/other photos/radiology-department/450x300/radiographers-mini.jpg" alt="radiographers-mini" class="grid-item">
                                    ...
                                    <div class="flex margin-bottom margin-top modalities-flex">
                                        ...
                                        <div class="col-30">
                                            <ul>
                                                ...
                                                <li><a href="radiology/ct-scan.html" class="sky-blue">CT Scan</a></li>                                             
                                            </ul>
                                        </div>
                                        <div class="col-30">
                                            <ul>
                                                <li><a href="radiology/ultrasound.html" class="sky-blue">Ultrasound</a></li>
                                                <li><a href="radiology/x-ray.html" class="sky-blue">X-ray</a></li>                                               
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="light-grey-border"></div>
