...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
            content="Sound waves are used to create images of inside organs, tissues, and structures in sonography, another name for ultrasound imaging." />
        <meta charset="UTF-8" />
                        ...
                        <div class="column-right col-70 welcome-text">
                            <div class="margin-bottom">
                                ...
                                <div class="margin-bottom">
                                    ...
                                    <p>Sonography, another name for ultrasound imaging, employs sound waves to produce
                                        pictures of inside organs, tissues, and structures. A transducer, a handheld
                                        device that transmits sound waves into the body in brief pulses, is used to
                                        deliver the sound waves. These waves are delivered to a computer, which converts
                                        them into a visual image as they reflect or echo back from the inside tissues.
                                    </p>
                                    <div class="department-img-container margin-bottom margin-top">
                                        <img src="../../../img/other photos/radiology-department/ultrasound-investigation.jpg"
                                            alt=" Ultrasound Scan machine" id="alignLeft">
                                    </div>
                                    <p>The reasons for pain, swelling up, and infection in the body's internal organs
                                        can be ascertained with the aid of diagnostic ultrasound. It may also serve as a
                                        guide for operations like breast biopsies. By examining real-time pictures of
                                        muscles, tendons, ligaments, nerves, and cartilage, musculoskeletal
                                        ultrasonography is used to assess orthopedic and sports injuries.</p>
                                </div>

                                <div class=" margin-top margin-bottom">
                                    <h4 class="navy-blue">How can I get ready for the test?</h4>
                                    <p>You should dress comfortably on the day of the examination; when you get to the
                                        ultrasound exam location, you might be required to change into a gown. How to be
                                        ready for ultrasound examinations of particular body parts is described below.
                                    </p>
                                ...
                                <div class=" margin-top margin-bottom">
                                    ...
                                    <p>Ultrasound is a safe diagnostic method with no known dangers or adverse effects
                                        and does not involve the use of ionizing radiation, special dyes, or anesthesia.
                                    </p>
                                ...
                                <div class=" margin-top margin-bottom">
                                    ...
                                    <p>After the exam you can immediately resume your normal activities. A radiologist
                                        will analyze the ultrasound images and will share the results with the doctor
                                        who requested the exam. Your doctor will then discuss the results with you.</p>
                                </div>
