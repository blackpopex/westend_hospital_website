...
<html lang="en">
    <head>
        <title>
           Ultrasound Scanning - Radiology (Imaging Services) | Westend Hospital
        </title>
        <link rel="icon" type="image/x-icon" href="../../img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="Sound waves are used to create images of inside organs, tissues, and structures in sonography, another name for ultrasound imaging."/>
        <meta charset="UTF-8"/>
                            ...
                            <div class="margin-bottom">
                                <h3 class="navy-blue">
                                    ...
                                    <div class=" margin-top margin-bottom">
                                        <h4 class="navy-blue">How can I get ready for the test?</h4>
                                        <p>You should dress comfortably on the day of the examination; when you get to the ultrasound exam location, you might be required to change into a gown. How to be ready for ultrasound examinations of particular body parts is described below.</p>
                                       
                                        <!--Table comes here-->
                                         <table>
                                            <tr>
                                                <th class="sky-blue">Body Part</th>
                                                <th class="sky-blue">Requirement</th>
                                            </tr>
                                            <tr>
                                                <td>Abdomen</td>
                                                <td>Nothing to eat or drink 10 hours prior
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Aorta</td>
                                            ...
                                            <tr>
                                                <td>Bladder</td>
                                                <td>48 oz fluid completed 1 hour before exam time
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Breast</td>
                                            ...
                                            <tr>
                                                <td>Breast Core Biopsy/FNA/Cyst Aspiration</td>
                                                <td>No aspirin or blood thinner 3 days prior to procedure
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Extremity</td>
                                            ...
                                            <tr>
                                                <td>Pelvis</td>
                                                <td>64 oz fluid completed 1 hour before exam time
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Scrotum</td>
                                    ...
                                    <div class=" margin-top margin-bottom">
                                        <h4 class="navy-blue">Are there any dangers?</h4>
                                        <p>Ultrasound is a safe diagnostic method with no known dangers or adverse effects and does not involve the use of ionizing radiation, special dyes, or anesthesia.</p>
                                       
                                    </div>
                                  
                                    <div class=" margin-top margin-bottom">
                                        <h4 class="navy-blue">After the test</h4>
                                        <p>After the exam you can immediately resume your normal activities. A radiologist will analyze the ultrasound images and will share the results with the doctor who requested the exam. Your doctor will then discuss the results with you.</p>
                                    </div>
                                   ...
                                   <div class="margin-top margin-bottom reduced-heading-container">
                                    ...
                                    <ul>
                                        <li><a href="ct-scan.html" class="sky-blue">CT-Scan</a></li>
