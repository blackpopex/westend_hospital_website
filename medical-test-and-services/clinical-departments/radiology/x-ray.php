...
<html lang="en">
    <head>
        ...
        <meta name="description" content="The imaging procedure known as an x-ray uses low radiation doses to help with disease or injury diagnosis."/>
        <meta charset="UTF-8"/>
                            ...
                            <div class="margin-bottom">
                                <h3 class="navy-blue">
                                    ...
                                    <div class="margin-bottom">
                                        ...
                                        <p>Low radiation doses are used during the imaging process known as an x-ray to aid in the diagnosis of disease or injury. X-rays are the imaging technique that doctors utilize the most. We can capture a still, two-dimensional image of metal items, the air inside the body, and bones using x-rays. X-rays help find foreign things in the body as well as for diagnosing illnesses like shattered bones, arthritis, pneumonia, and intestinal blockage.</p>
                                        <div class="department-img-container margin-bottom margin-top">
                                            <img src="../../../img/other photos/radiology-department/x-ray.jpg" alt="X-ray machine" id="alignLeft">
                                        </div>
                                        <p>Westend hospital Radiology offers walk-in X-ray services for out-patient, at its facility.</p>                                                   
                                    </div>                                                               

                                    <div class=" margin-top margin-bottom">
                                        <h4 class="navy-blue">How should I get ready for the exam?</h4>
                                        <p>For an x-ray, no extra preparation is required. When you arrive at the x-ray investigation room, you might be required to change into a gown depending on the investigation and area of interest. </p>
                                       
                                    </div>
                                    <div class=" margin-top margin-bottom">
                                        <h4 class=" navy-blue">What will occur throughout the test?</h4>
                                        <p>We will ask you to lie on or stand close to the x-ray table in a specified position depending on the part of the body being inspected. We'll put a lead apron over other parts of your body to shield them from radiation exposure. During the many seconds it takes to create the image, we could ask you to maintain extreme stillness, and we might take more than one picture of the body part we're examining.</p>
                                       
                                    </div>
                                    <div class=" margin-top margin-bottom">
                                        <h4 class="navy-blue">After the test</h4>
                                        <p>The doctor who requested the exam will be informed of the results of the radiologist's analysis of the X-ray images. The outcomes will then be discussed with you by your doctor.</p>
                                    </div>
