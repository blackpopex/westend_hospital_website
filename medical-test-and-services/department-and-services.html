...
<html lang="en">
    <head>
        <title>
            Departments and Services | Westend Hospital
        </title>
        <link rel="icon" type="image/x-icon" href="../img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="We are committed to delivering the best healthcare services by using a patient-centric approach hence our hospital is divided into clinical departments consisting of Radiology, Laboratory, Pharmacy, Geriatric, Paediatrics, Gynaecology, etc, and patient support departments consisting of Account, Outpatient, Occupational Health, Insurance, etc."/>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <main>
            <div class="section-background-image departments-and-services">
                <div class="container">
                    <h2 class="subnavbar-color">Departments and Services</h2>
                    <ul class="inline-block-breadcrumb subnavbar-color">
                        <li>
                            <a href="../index.html">Home</a>
                        </li>
                        <li>Departments and services</li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="flex">
                                ...
                                <div class="column-left">
                                    ...
                                    <div class="quick-links">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="A-Z-of-all-medical-test.html">A-Z of medical Test</a></li>
                                            <li><a href="A-Z-of-all-medical-services.html">A-Z of medical Services</a></li>
                                            <li><a href="department-and-services.html">Department & Services</a></li>
                        ...
                        <div class="column-right col-70">
                            <div class="margin-bottom">
                                <h3 class="navy-blue">Clinical Departments</h3>
                                <div class="flex department-services">
                                    <ul>
                                        <li>
                                            <a href="clinical-departments/anesthesiology-and-perioperative.html">Anesthesiology & Perioperative</a>
                                        </li>
                                        <li>
                                            <a href="clinical-departments/audiometry.html">Audiometry</a>
                                        </li>                                    
                                        <li>
                                            <a href="clinical-departments/emergency-medicine.html">Emergency Medicine</a>
                                        </li>
                                        <li>
                                            <a href="clinical-departments/ear-nose-and-throat.html">Ear, Nose & Throat</a>
                                        </li>
                                        <li>
                                            <a href="clinical-departments/geriatric.html">Geriatric</a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="clinical-departments/laboratory.html">Laboratory</a>
                                        </li>
                            ...
                            <div class="margin-top">
                                <h3 class="navy-blue">Patient Support Services</h3>
                                <div class="flex department-services">
                                    <ul>
                                        <li>
                                            <a href="patient-support-services/account.html">Account</a>
                                        </li>
                                        <li>
                                            <a href="patient-support-services/client-relations.html">Client Relations</a>
                                        </li>
                                        <li>
                                            <a href="patient-support-services/insurance2.html">Insurance</a>
                                        </li>                                      
                                        <li>
                                            <a href="patient-support-services/nursing.html">Nursing</a>
                                        </li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="patient-support-services/out-patient-department.html">Outpatient Department</a></li>
