...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
            content="We are committed to delivering the best healthcare services by using a patient-centric approach hence our hospital is divided into clinical departments consisting of Radiology, Laboratory, Pharmacy, Geriatric, Paediatrics, Gynaecology, etc, and patient support departments consisting of Account, Outpatient, Occupational Health, Insurance, etc." />
        <meta charset="UTF-8" />
                                ...
                                <div class="column-left">
                                    ...
                                    <div class="quick-links">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="A-Z-of-all-medical-test">A-Z of medical Test</a></li>
                                            <li><a href="A-Z-of-all-medical-services">A-Z of medical Services</a></li>
                                            <li><a href="department-and-services">Department & Services</a></li>
                        ...
                        <div class="column-right col-70">
                            <div class="margin-bottom">
                                ...
                                <div class="flex department-services">
                                    <ul>
                                        <li>
                                            <a href="clinical-departments/anesthesiology-and-perioperative">Anesthesiology
                                                & Perioperative</a>
                                        </li>
                                        <li>
                                            <a href="clinical-departments/audiometry">Audiometry</a>
                                        </li>
                                        <li>
                                            <a href="clinical-departments/emergency-medicine">Emergency Medicine</a>
                                        </li>
                                        <li>
                                            <a href="clinical-departments/ear-nose-and-throat">Ear, Nose & Throat</a>
                                        </li>
                                        <li>
                                            <a href="clinical-departments/geriatric">Geriatric</a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="clinical-departments/laboratory">Laboratory</a>
                                        </li>
                                        <li><a href="clinical-departments/molecular">Molecular</a></li>
                                        <li><a href="clinical-departments/obstetrics-and-gynecology">Obstetrics and
                                                Gynecology</a></li>
                            ...
                            <div class="margin-top">
                                ...
                                <div class="flex department-services">
                                    <ul>
                                        <li>
                                            <a href="patient-support-services/account">Account</a>
                                        </li>
                                        <li>
                                            <a href="patient-support-services/client-relations">Client Relations</a>
                                        </li>
                                        <li>
                                            <a href="patient-support-services/insurance2">Insurance</a>
                                        </li>
                                        <li>
                                            <a href="patient-support-services/nursing">Nursing</a>
                                        </li>
                                        <li><a href="patient-support-services/medical-records">Medical Record</a></li>
                                    </ul>
                                    <ul>
                                        <li><a href="patient-support-services/occupational-health">Occupational
                                                Health</a></li>
                                        <li><a href="patient-support-services/out-patient-department">Outpatient
                                                Department</a></li>
