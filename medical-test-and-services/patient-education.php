...
<html lang="en">
    ...
    <head>
        <title>
            Patient Education | Westend Hospital
        </title>
        <link rel="icon" type="image/x-icon" href="../img/logo/favicon.ico.png" />
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css" />
        <meta name="description" content="To keep our patients and visitors aware about the latest developments in the healthcare industry, we provide education services by regularly posting articles on health-related topics.
        Our papers cover issues like anxiety disorder and dysthymia, among others. " />
        <meta charset="UTF-8" />
                ...
                <div class="container align-start column-reverse">
                    <div class="flex">
                            ...
                            <aside>
                                ...
                                <div class="column-left">
                                    ...
                                    <div class="quick-links">
                                        <h4 class="navy-blue">More Article</h4>

                                        <div>
                                            <h5 class="sky-blue">Paediatric</h5>
                                            <ul>
                                                <li><a href="patient-education">Adolescent Mental Health</a></li>
                                        ...
                                        <div>
                                            <h5 class="sky-blue">Healthy lifestyle</h5>
                                            <ul>
                                        ...
                                        <div>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="A-Z-of-all-medical-services">A-Z of medical Services</a>
                                                </li>
                        ...
                        <div class="column-right col-70">
                            ...
                            <p>There are many different mental health problems affecting adolescents that require the
                                clinical care of a physician or other healthcare professional. Listed in the directory
                                below are some, for which we have provided a brief overview.</p>
                            <div class="article-container flex">
                                <!--set each box to 30%-->
                                <a class=" article-box col-30" href="adolescent-mental-health/anxiety-disorders">
                                ...
                                <a class=" article-box col-30" href="adolescent-mental-health/dysthymia">
                                    <img src="../img/articles-image/anxiety disrorder 2.jpg" alt="Dysthymia">
                                    <div class="title transparent-navy-blue">
                                        <h4>Dysthymia</h4>
                                    </div>
                                </a>
                                <a class=" article-box col-30" href="adolescent-mental-health/phobias">
                                    <img src="../img/articles-image/anxiety disrorder.jpg" alt="Phobias">
                                    <div class="title transparent-sky-blue">
                                        <h4>Phobias</h4>
                                    </div>
                                </a>
                                <a class=" article-box col-30" href="adolescent-mental-health/post-traumatic-stress">
                                    <img src="../img/articles-image/anxiety disrorder 2.jpg"
                                        alt="Post-Traumatic Stress Disorder">
                                    <div class="title transparent-navy-blue">
                                        <h4>Post-Traumatic Stress</h4>
                                    </div>
                                </a>
                                <a class=" article-box col-30" href="adolescent-mental-health/behaviour-disorder">
