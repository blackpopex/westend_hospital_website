...
<html lang="en">
    <head>
        <title>
          Cafeteria - Patient Support Services | Westend Hospital</title>
        <link rel="icon" type="image/x-icon" href="../../img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="Our Cafeteria is world-class and consists of several food options – from made-to-order food, popcorn, salad, ice cream, drinks, and other varieties – with ample indoor and outdoor seating. Our cafeteria features includes a large dining area with restaurant-style seating, fresh and healthy menu choices, grab-and-go takeout options, and daily plate specials and entreés."/>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <main>
            <div class="section-background-image departments-and-services">
                <div class="container">
                    <h2 class="subnavbar-color">Cafeteria</h2>
                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70 welcome-text">
                            <div class="margin-bottom">
                                <h3 class="navy-blue">
                                    Dining at Westend Hospital</h3>
                                    <div class="margin-bottom">
                                        <p>Patients, visitors, and staff have access to a full range of food options inside our cafeteria – from made-to-order food, popcorn, salad, ice cream, drinks, and other varieties – with ample indoor and outdoor seating. Microwaves are also available inside the cafeteria. Cash and bank transfer are accepted as means of making payment.</p>
                                        <p>The Hospital cafeteria is located on the first floor and is open Monday through Saturday for breakfast, lunch, and dinner.</p>                                              
                                    </div>

                                      <!--GRID CONTAINER-->
                                    <div class="grid-photo-main-container department-img-container margin-bottom">
                                        <div class="grid-wrapper flex">
                                            <img src="../../img/other photos/cafetaria.jpg" alt="Westend Hospital Cafeteria" class="grid-item large-grid-item">
                                            <img src="../../img/other photos/food-photo/rice.jpg" alt="Jollof Rice" class="grid-item">
                                            <img src="../../img/other photos/food-photo/Igusi-soup.jpg" alt="Iguis Soup" class="grid-item">
                                            <img src="../../img/other photos/food-photo/banga-soup.jpg" alt="Banga soup" class="grid-item">
                                            <img src="../../img/other photos/food-photo/fried-rice.jpg" alt="fried Rice" class="grid-item">
                                            <img src="../../img/other photos/food-photo/beans.jpg" alt="Beans" class="grid-item">
                                            <img src="../../img/other photos/food-photo/ice-cream.jpg" alt="Ice Cream" class="grid-item">
                                        </div>
                                    </div>

                                    <div class="margin-bottom  enlisted-items">  
                                        <h4 class="navy-blue">Our cafeteria features</h4> 
                                                <ul class="square-list-type" id="squareList">
                                                    <li>A large dining area with restaurant-style seating.</li>                                           
                                                    <li>Fresh and healthy menu choices.</li>                                           
                                                    <li>Grab-and-go takeout options</li>                                           
                                                    <li>Daily plate specials and entreés</li>                                                                                   
                                                </ul>
                                    </div>
                                 
                                    <div class="margin-bottom">  
                                        <h4 class="navy-blue">Meal Service Hours</h4> 
                                         <ul style="padding-left: 0">
                                             <li><p><b class="sky-blue">Breakfast:</b> 8:00am - 11:00am</p></li>                                           
                                             <li><p><b class="sky-blue">Lunch:</b> 12:00pm - 3:30pm</p></li>                                           
                                             <li><p><b class="sky-blue">Dinner:</b> 4:30pm - 7:00pm</p></li>                                                                                                                           
                                        </ul>
                                        
                                    </div>
                                    <div class="margin-bottom ">  
                                        <h6 style="margin-top: 0; margin-bottom: 0;">For Special Order</h6> 
                                       <p>+234 (0) 905 376 4745</p>
                                    </div>
                                    <div class="margin-bottom">  
                                        <h4 class="navy-blue">After Hours</h4> 
                                        <p>Our after hours visitors and employees can purchase drinks from the hospital’s pharmacy department.</p>
                                    </div>
                                    <div class="margin-bottom">  
                                        <h4 class="navy-blue">Special Dietary Needs</h4> 
                                        <p>Our patient convenient food service includes a special menu for those who deal with life-threatening allergies.</p>
                                    </div>
                                    <div class="margin-bottom">  
                                        <h4 class="navy-blue">Patient Meal Service</h4> 
                                        <p>Depending upon physician's guidelines for your diet, we can accommodate a variety of modified diets. Patients who do not receive a selective menu will be given foods based on their preference whenever possible.</p>
                                    </div>
                            </div>
