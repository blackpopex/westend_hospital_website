...
<html lang="en">
    <head>
        <title>
             Client Relations - Patient Support Services | Westend Hospital</title>
        <link rel="icon" type="image/x-icon" href="../../img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="Professionals in our client relations department work to develop, uphold, and grow the company's relationship with its clients.
        These specialists have received specialized training, and their main duty is to attract new consumers and maintain customer loyalty by providing optimum customer satisfaction. "/>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <main>
            <div class="section-background-image departments-and-services">
                <div class="container">
                    <h2 class="subnavbar-color">Client Relations Department</h2>
                    <ul class="inline-block-breadcrumb subnavbar-color">
                        ...
                        <li>Client Relations Department</li>
                    </ul>
                </div>
            </div>

            <section id="Client-Relations-Department">
                    ...
                    <div class="flex">
                                ...
                                <div class="column-left">
                                    ...
                                    <div class="quick-links department-quicklinks">
                                        ...
                                        <ul class="accordion-content" id="menuDropdown">
                                            ...
                                            <li><a href="/medical-test-and-services/clinical-departments/anesthesiology-and-perioperative.html">Anesthesiology & Perioperative</a></li>
                                            <li><a href="/medical-test-and-services/clinical-departments/audiometry.html">Audiometry</a></li>
                                            <li><a href="/medical-test-and-services/clinical-departments/ear-nose-and-throat.html">Ear, Nose & Throat</a></li>
                                            <li><a href="/medical-test-and-services/clinical-departments/emergency-medicine.html">Emergency Medicine</a></li>
                                            <li><a href="/medical-test-and-services/clinical-departments/geriatric.html">Geriatric</a></li>
                                            <li><a href="#/">Immunization</a></li>
                                            <li><a href="/medical-test-and-services/clinical-departments/laboratory.html">Laboratory</a></li>
                                            <li><a href="/medical-test-and-services/clinical-departments/molecular.html">Molecular</a></li>
                                            <li><a href="/medical-test-and-services/clinical-departments/obstetrics-and-gynecology.html">Obstetrics and Gynecology</a></li>
                                            <li><a href="/medical-test-and-services/clinical-departments/pharmacy.html">Pharmacy</a></li>
                                            <li><a href="/medical-test-and-services/clinical-departments/physiotherapy.html">Physiotherapy</a></li>
                                            <li><a href="/medical-test-and-services/clinical-departments/radiology.html">Radiology</a></li>                                           
                                        </ul>
                        ...
                        <div class="column-right col-70 welcome-text">
                            <div class="margin-bottom">
                                <h3 class="navy-blue">
                                    Welcome to Client Relations Department</h3>
                                    <div class="margin-bottom">
                                        <p>The client Relations Department is made up of professionals who work to build, maintain and strengthen the company's relationship with its clients. They are a team of specially trained professionals whose primary responsibility is to engage new clients and ensure customer retention by ensuring maximum customer satisfaction. They communicate with clients to better understand what goals they aim to accomplish and demonstrate how Westend Hospital’s product or service can help them meet these objectives and benefit their business.                                                                                   </p>

                                        <p> Our Client Relations officers provide an opportunity for the clients to express their praise, concerns, complaints, questions, and suggestions. They ensure that the voice of the client is heard by the management to ensure prompt attention and maximum satisfaction is received by the client. The Clients Relations Department is trained to treat all the concerns raised by the clients sensitively, objectively, and in confidence.</p>
                                    </div>

                                    <div class="margin-bottom margin-top">  
                                        <h4 class="navy-blue">Feedback</h4>                                  
                                        <p>We appreciate all inputs and complaints from our patients, clients, and families because it gives us the chance to evaluate the services we offer, enabling us to continue to provide compassionate and high-quality healthcare services.</p>
                                    </div>
                                    <div class="margin-bottom margin-top">  
                                        <h4 class="navy-blue">How we can assist you</h4>                                  
                                        <p>We will listen to you and take adequate steps to ensure your worries receive the required attention. Choose the best point of contact to assist you in resolving your issues.</p>
                                    </div>

                                    <div class="margin-bottom margin-top">  
                                        <h4 class="navy-blue">Working Hours:</h4>                                  
                                        <p>Monday through Friday, 8 a.m. to 5 p.m.</p>
                                    </div>

                                                                           
                                    <div class="light-grey-border"></div>
                                    <h4 class="navy-blue margin-top scheduling-heading">Client Relations Central Scheduling</h4>
                                    <div class="scheduling margin-bottom">
                                        <ul>
                                            <li><span class=" fa fa-phone-alt navy-blue"></span> +234 (0) 807 401 0946</li>
                                            <li><span class="fa fa-envelope navy-blue"></span> <a href="mailto:clientrelations@thewestendhospital.com">clientrelations@thewestendhospital.com</a></li>
                                        </ul>
                                    </div>
                            </div>
                        </div>
