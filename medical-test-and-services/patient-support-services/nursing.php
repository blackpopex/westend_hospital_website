                        ...
                        <div class="column-right col-70 welcome-text">
                            <div class="margin-bottom">
                                <h3 class="navy-blue">
                                    ...
                                    <div class="margin-bottom">
                                        <p>A nursing unit is a specialized division that is usually found in a hospital setting and is devoted to patients with particular needs. Each nurse in a nursing unit has been trained on how to handle different categories of patients. Our nurses collaborate with staff from allied disciplines, including dietetics, medical social service, pharmacy, etc. to provide holistic individualized care in the hospital.</p>
                                        <p>The nursing staff at Westend is committed to providing the best care possible for patients and their families, with a focus on their individual needs. They are driven by a desire for perfection and excellence.</p>                                              
                                    </div>

                                      <div class="department-img-container margin-bottom margin-top">
                                        <div class="flex">
                                            <div class="col-30">
                                                <img src="../../img/other photos/Nurses/Westend-Hospital-Nurses.jpg" alt="Westend hospital nurses">
                                            </div>
                                            <div class="col-30">
                                                <img src="../../img/other photos/Nurses/nurses-surgery.jpg" alt="Westend hospital nurses during surgery">
                                            </div>
                                            <div class="col-30">
                                                <img src="../../img/other photos/Nurses/Westend-nurse-labour-room.jpg" alt="Westend nurse in labour room">
                                            </div>              
                                        </div>
                                    </div>
                                    ...
                                    <div class="margin-bottom margin-top">  
                                        ...
                                        <p> Quality patient care and patient safety are the top priorities of the nursing staff at Westend Hospital. Our goal of becoming a dependable leader in improving health and providing care for people calls for steadfast dedication to both. </p>    
                                        <p>As we endeavor to guarantee that they constantly receive safe, high-quality efficient care, we invite our patients to join us as our partners. </p>                             
                                        <p>Care, compassion, and clinical excellence are all infused into our patient-first mindset to deliver:</p>                                 
                                         <ul class="square-list-type" id="squareList">
                                            <li><span class="sky-blue"><b>Highest level of care: </b></span> We'll score as highly as we can on all quality-related metrics.</li>                                           
                                            <li><span class="sky-blue"><b>Transparency:</b></span>  We'll be open about both our achievements and the things we want to do better.</li>                                           
                                        </ul>
                                    </div>
                                    <div class="margin-bottom margin-top">  
                                        <h4 class="navy-blue">Federal requirements</h4> 
                                        <p> We evaluate ourselves using nurse quality measures that have been nationally recognized.</p>                                 
                                    </div>
                                    <div class="margin-bottom margin-top">  
                                        <h4 class="navy-blue">Why join us? </h4> 
                                        <p>In addition to being valued by their physician colleagues and supported by a dedication to evidence-based care practices and professional development, nurses at Westend Hospital are an essential component of the care team.</p>
                                        <p>With the help of our Distributed Care Delivery Network, you can advance your nursing career and discover fresh, original approaches to practice. Consider being a member of our team of professionals that provide patients with high-quality treatment every day.</p>                                 
                                      
                                    </div>
                                     <div class="margin-bottom margin-top">  
                                        <h6 class="sky-blue">Customer service</h6> 
                                        <p>By taking care of their bodily needs, avoiding disease, and treating medical issues, we serve as caretakers for our patients. Nurses must watch and monitor the patient while documenting any pertinent data to support treatment decision-making.</p>                                 
                                        <p>Nurses treat wounds, give medication, perform regular physicals, take thorough medical histories, monitor vital parameters, run diagnostic tests, handle medical equipment, take blood samples, and admit and discharge patients on doctor's orders.</p>                                                              
                                    </div>
                                     <div class="margin-bottom margin-top">  
                                        <h6 class="sky-blue">Advocacy for patients</h6> 
                                        <p>At Westend Hospital, nurses frequently offer their patients and family emotional assistance in addition to their clinical duties. This can involve listening to patients and determining their physical, emotional, cultural, and mental requirements, as well as making sure they comprehend their therapy and are ready for it.</p>                                                                                          
                                    </div>
                                     <div class="margin-bottom margin-top">  
                                        <h6 class="sky-blue">Care preparation</h6> 
                                        <p>The choice of how to treat patients is directly influenced by a nurse. As a result, our nurses consider all available information while evaluating patient signs and spotting potential issues to provide the best advice.</p>                                                                                          
                                    </div>
                                     <div class="margin-bottom margin-top">  
                                        <h6 class="sky-blue">Patient support and education</h6> 
                                        <p>The nurses at Westend hospitals are in charge of making sure that patients have the best possible understanding of their health, ailments, drugs, and treatments. This is crucial when patients are discharged from the hospital and left to continue their care on their private schedule at home.</p>                                                                                          
                                    </div>
                                    ...
                                    <div class="scheduling margin-bottom">
                                        <ul>
                                            ...
                                            <li><span class="fa fa-envelope navy-blue"></span> <a href="mailto:nursing@thewestendhospital.com">nursing@thewestendhospital.com</a></li>
                                            <li><span class="fa fa-envelope navy-blue"></span> <a href="mailto:nursingmanager@thewestendhospital.com">nursingmanager@thewestendhospital.com</a></li>
                                        </ul>
                                    </div>
