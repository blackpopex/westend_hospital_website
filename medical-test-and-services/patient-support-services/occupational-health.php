...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
            content="The multidisciplinary occupational health department of Westend Hospital is focused on the welfare, health, and safety of workers.
                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70">
                            <div class="margin-bottom">
                                ...
                                <div class="margin-bottom">
                                    <p>Occupational Safety and Health Department, also commonly referred to as
                                        Occupational Health Department is a multidisciplinary department concerned with
                                        the safety, health, and welfare of people at work. The Occupational Health
                                        Department is fully equipped with state-of-the-art medical equipment and
                                        professionals, trained to provide clinical treatments with a focus on
                                        prevention. We identify and treat occupational diseases, assess our patients'
                                        working environments to see if additional employees may be at risk, and
                                        recommend ways to make workplaces better.</p>


                                    <div class="department-img-container margin-top">
                                        <div class="flex">
                                            <img src="../../img/other photos/men-at-work4.jpg" alt="men at work"
                                                class="men-at-work">
                                    ...
                                    <p>The Occupational Health Department's primary objective is to promote employees'
                                        health and working capacity; improve working conditions and make the workplace
                                        environment become safe and healthful; develop work organizations and working
                                        cultures that should reflect the fundamental value systems adopted by the
                                        concerned undertaking, and include efficient managerial systems, personnel
                                        policy that is aimed at safety and health promotion of the employee.</p>

                                </div>
                                <div>
                                    <h5 class="navy-blue">Requirement for Occupational Health Screening</h5>
                                    <ul class="square-list-type margin-top" id="squareList">
                                        <li>Set aside approximately 4 hour for the entire process – please arrive early
                                            for your screening exercise, and at least before 9:00am.</li>
                                        <li>Bring an unexpired photo ID (i.e. Driver’s License/Passport), list of your
                                            current medications, eyeglasses/contacts for vision testing, and any other
                                            pertinent medical information that may assist us in medically clearing you
                                            for this position.</li>
                                        <li>If you have vaccination, immunization and/or blood titer information from
                                            your doctor or another employer bring them with you to your appointment.
                                            View required tests/vaccinations.</li>
                                        <li>Do not bring children to your appointment.</li>
                                        <li>Call Occupational Health and your recruiter if you are cancelling your
                                            appointment or will be delayed.</li>
                                    </ul>
                                </div>
                                ...
                                <div class="margin-bottom margin-top">
                                    ...
                                    <ul class="square-list-type" id="squareList">
                                        <li><a href="#/" class="sky-blue">Registration for Occupational Health
                                                Services</a></li>
                                        <li><a href="#/" class="sky-blue">Immunization and Screening Record</a></li>
                                        <li><a href="#/" class="sky-blue">Health History Questionnaire Assessment</a>
                                        </li>
                                        <li><a href="#/" class="sky-blue">TB Screening Form</a></li>
                                        <li><a href="#/" class="sky-blue">Employment Substance Abuse Test Consent
                                                Form</a></li>
                                ...
                                <h4 class="navy-blue margin-top scheduling-heading">Occupational Health Central
                                    Scheduling</h4>
                                <div class="scheduling margin-bottom">
                                    <ul>
                                        ...
                                        <li><span class="fa fa-envelope navy-blue"></span>
                                            occupationalhealth@thewestendhospital.com</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
