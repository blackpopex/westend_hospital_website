                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70 welcome-text">
                            <div class="margin-bottom">
                                ...
                                <div class="margin-bottom">
                                    <p>We employ a variety of security measures, such as the usage of CCTV cameras and
                                        electronic intercom for effective communication with the security unit, to keep
                                        staff, patients, and visitors secure.</p>
                                    <p>We are experienced in offering hospital security services for aggressive patient
                                        schemes, with a focus on safeguarding both personnel and the general public.</p>
                                    <p>Security in hospitals, private health facilities, and other healthcare
                                        organizations is a special challenge. Patients and visitors must feel
                                        comfortable and secure because emotions can sometimes run high in these
                                        settings.</p>
                                    <p>You must respect the hospital's visiting hours and the patients' daytime rest
                                        times as a guest. Check with the hospital to see if it's all right to bring a
                                        gift or item for a loved one. Our wards forbid loud noises, smoking, and hard
                                        drugs. </p>
                                    <p>It might be upsetting at times to witness a loved one in discomfort or suffering.
                                        Respect the hospital staff, fellow patients, and visitors at all times. Abuse of
                                        any kind, whether physical or verbal, of staff members, patients, or other
                                        visitors will not be tolerated, and you risk being asked to leave if you act in
                                        this way.</p>
                                </div>
                                ...
                                <div class="margin-bottom margin-top">
                                    ...
                                    <ul class="square-list-type" id="squareList">
                                        ...
                                        <li>Addressing any situations that could endanger the patient's or staff's
                                            security.</li>
                                        <li>Diffusing tense circumstances.</li>
                                        <li>Where necessary, cooperate with the police and other emergency services.
                                        </li>
