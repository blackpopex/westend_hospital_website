...
<html lang="en">
    <head>
        <title>
             Security - Patient Support Services | Westend Hospital</title>
        <link rel="icon" type="image/x-icon" href="../../img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="Our security department ensures visitors have a purpose for being in the hospital, addresses any situations that could endanger the patient's or staff's security, diffuses tense circumstances, and perform other security-related duties. 
        "/>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <main>
            <div class="section-background-image departments-and-services">
                <div class="container">
                    <h2 class="subnavbar-color">Security Department</h2>
            ...
            <section id="Security-Department">
                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70 welcome-text">
                            <div class="margin-bottom">
                                <h3 class="navy-blue">
                                    Welcome to Security Department</h3>
                                    <div class="margin-bottom">
                                        <p>We employ a variety of security measures, such as the usage of CCTV cameras and electronic intercom for effective communication with the security unit, to keep staff, patients, and visitors secure.</p>
                                        <p>We are experienced in offering hospital security services for aggressive patient schemes, with a focus on safeguarding both personnel and the general public.</p>
                                        <p>Security in hospitals, private health facilities, and other healthcare organizations is a special challenge. Patients and visitors must feel comfortable and secure because emotions can sometimes run high in these settings.</p>
                                        <p>You must respect the hospital's visiting hours and the patients' daytime rest times as a guest. Check with the hospital to see if it's all right to bring a gift or item for a loved one. Our wards forbid loud noises, smoking, and hard drugs. </p>
                                        <p>It might be upsetting at times to witness a loved one in discomfort or suffering. Respect the hospital staff, fellow patients, and visitors at all times. Abuse of any kind, whether physical or verbal, of staff members, patients, or other visitors will not be tolerated, and you risk being asked to leave if you act in this way.</p>                                
                                    </div>

                                    <div class="margin-bottom margin-top">  
                                        <h4 class="navy-blue">Our security officer's duties include:</h4>                                  
                                         <ul class="square-list-type" id="squareList">
                                            <li>Making sure visitors have a purpose for being in the hospital.</li>                                           
                                            <li>Addressing any situations that could endanger the patient's or staff's security.</li>                                           
                                            <li>Diffusing tense circumstances.</li>                                           
                                            <li>Where necessary, cooperate with the police and other emergency services.</li>                                           
                                            <li>Patrolling the hospital's grounds from the inside and outside.</li>                                           
                                            <li>Close CCTV monitoring from the control room.</li>                                                                      
                                        </ul>
                                    </div>
                                    ...
                                    <h4 class="navy-blue margin-top scheduling-heading">Need Security? Call Now</h4>
