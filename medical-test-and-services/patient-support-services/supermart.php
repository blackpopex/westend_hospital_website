...
<html lang="en">
    <head>
        <title>
           Supermart - Patient Support Services | Westend Hospital</title>
        <link rel="icon" type="image/x-icon" href="../../img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="Westend hospitals, has opened “mini supermart” to support staff and visitors. The onsite supermart services are available to all hospital workers, patient’s relatives and visitors. We sell breverages, cosmetics, drinks and many more."/>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <main>
            <div class="section-background-image departments-and-services">
                <div class="container">
                    <h2 class="subnavbar-color">Supermart</h2>
                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70 welcome-text">
                            <div class="margin-bottom">
                                <h3 class="navy-blue">
                                    Mini Supermart for Staff & Visitors</h3>
                                    <div class="margin-bottom">
                                        <p>Westend hospital has opened a “mini supermart” to support staff and visitors. The onsite supermart services are available to all hospital workers, patient’s relatives, and visitors.</p>
                                        <p>Its goal is to provide essential items at an affordable cost and conveniently reduce extra trips to the supermart stores elsewhere in town to find basic items, such as snacks, drinks, and many other options of varieties for relaxation while waiting to be attended to.</p>                                              
                                    </div>

                                      <div class="department-img-container margin-bottom margin-top">
                                        <div class="flex">
                                            <div class="col-30">
                                                <img src="../../img/other photos/supermart-folder/supermart.jpg" alt="Westend hospital supermart">
                                            </div>
                                            <div class="col-30">
                                                <img src="../../img/other photos/supermart-folder/supermart-inside.jpg" alt="Westend hospital supermart inside">
                                            </div>
                                            <div class="col-30">
                                                <img src="../../img/other photos/supermart-folder/supermart-inside-section-two.jpg" alt="Westend hospital supermart inside">
                                            </div>              
                                        </div>
                                       </div>

                                    <div class="margin-bottom margin-top enlisted-items">  
                                        <p>Items we stock includes but not limited to:</p> 
                                    ...
                                    <div class="margin-bottom margin-top">  
                                        <h4 class="navy-blue">Our Location</h4> 
                                        <p>We are located at Westend Hospital Car Park 2.</p>
                                    </div>
                                    <div class="margin-bottom margin-top">  
                                    ...
                                    <div class="margin-bottom margin-top">  
                                        <h4 class="navy-blue">Hotlines</h4> 
