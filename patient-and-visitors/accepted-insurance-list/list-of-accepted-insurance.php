...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
            content="Our extensive list outlines the different health plans that Westend Hospital supports. With the help of this list, both patients and visitors can quickly learn about the various HMOs and insurance plans that the hospital supports, including but not limited to Hygeia, RedCare, Novo Health, Avon, Axa Mansard, Clearline, etc." />
        <meta charset="UTF-8" />
                                ...
                                <div class="column-left">
                                    ...
                                    <div class="quick-links">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="../vistors">Visitors</a>
                                            </li>
                                            <li>
                                                <a href="../your-hospital-stay">Your Hospital Stay</a>
                                            </li>
                                            <li>
                                                <a href="../billing-and-financial-asistance">Billing and Financial
                                                    Asistance</a>
                                            </li>
                                            <li>
                                                <a href="../accepted-insurance">Accepted Insurance</a>
