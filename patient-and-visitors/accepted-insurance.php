...
<html lang="en">
    <head>
        ...
        <meta name="description" content="While Westend Hospital accepts a number of insurance plans, we work hard to ensure that patients are aware of how insurance policies and healthcare benefits impact both the availability and cost of care."/>
        <meta charset="UTF-8"/>
                    ...
                    <div class="flex">
                        ...
                        <div
                            ...
                            <div class="margin-bottom">
                                ...
                                <p>To meet increase in demand for quality healthcare, Westend hospital accept variety of insurance plans including redcare, Hygeia, SHT, Novo Health, and many more. We understand that it can be stressful and frustrating to navigate the insurance coverage process, but we strive to make it as smooth as possible.</p>

                                <p>While we accepts majority of health insurance plans, it is imperative you check with your insurance company before your medical visit to confirm that we accept your insurance and to verify your benefits and coverage.</p>

                                <p>To confirm if your insurance plan is accepted for medical care at our facility, please review our list of accepted insurance companies below.</p>
                                <p><a href="./accepted-insurance/list-of-accepted-insurance.html" class="sky-blue">List of health Insurance accepted by Westend Hospital</a></p>
                            </div>
                            <!--Accepted Insurance-->
                            <div class="margin-bottom">
                                <h4 class="navy-blue">For Accepted insurance</h4>
                                <p>Congratulations, now that your insurance company is accepted, please contact them to confirm what care is covered by your plan as well as information on copayments, deductibles or other out-of-pocket expenses and coinsurance amounts.</p>
                            </div>
                            <!-- Non-Accepted insurance-->
                            <div class="margin-bottom">
                                <h4 class="navy-blue">For Non-Accepted insurance</h4>

                                <p>Since your insurance plan is not accepted or considered out-of-network, this may lead to greater out-of-pocket expenses for your care. Please contact your insurance provider for details about what your financial responsibility may be if you choose to receive care at Westend Hospital. </p>
                            </div>
