...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Our extensive list outlines the different health plans that Westend Hospital supports. With the help of this list, both patients and visitors can quickly learn about the various HMOs and insurance plans that the hospital supports, including but not limited to Hygeia, RedCare, Novo Health, Avon, Axa Mansard, Clearline, etc."/>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <!---------------------------MAIN PAGE CONTENT---------------------------------------------->
        <main>
            <div class="section-background-image list-of-accepted-insurance">
                <div class="container">
                    <h2 class="subnavbar-color">List of Accepted Insurance</h2>
                    <ul class="inline-block-breadcrumb subnavbar-color">
                        <li>
                            <a href="../../index.html">Home</a>
                        </li>
                        <li>
                            <a href="../accepted-insurance.html">accepted-insurance</a>
                        </li>
                        <li>List of accepted Insurance</li>
                    </ul>
                </div>
            </div>

            <section id="list-of-accepted-insurance">
                <div
                ...
                <div class="flex">
                            ...
                            <div class="column-left">
                                ...
                                <div class="quick-links">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="../vistors.html">Visitors</a>
                                        </li>
                                        <li>
                                            <a href="../your-hospital-stay.html">Your Hospital Stay</a>
                                        </li>
                                        <li>
                                            <a href="../billing-and-financial-asistance.html">Billing and Financial Asistance</a>
                                        </li>
                                        <li>
                                            <a href="../accepted-insurance.html">Accepted Insurance</a>
                                        </li>
                                        <li>
                                            <a href="../patient-rights.html">Patient Rights</a>
                                        </li>
                    ...
                    <!--Accepted insurance-->
                    <div>
                        <h3 class="navy-blue">Westend Hospital accepts the below health insurance/HMO.</h3>
                        <!--Health insurance and contact details-->
                        <table>
                            <tr>
                                <th class="sky-blue">Insurance</th>
                                <th class="sky-blue">Contact Details</th>
                            </tr>
                            <tr>
                                <td>Hygeia</td>
                                <td>+234 (0) 807 420 3063
                                </td>
                            </tr>
                            <tr>
                                <td>RedCare</td>
