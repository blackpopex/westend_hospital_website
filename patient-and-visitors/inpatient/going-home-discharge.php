...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
            content=" A hospital discharge is a process where you no longer need to receive inpatient care and can go home to continue care. Before your discharge, it is important to make a list of all your possible questions. Take note of your care team's reply and ensure all question asked is adequately answered. " />
        <meta charset="UTF-8" />
                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70">
                            ...
                            <div class="margin-bottom">
                                ...
                                <p>To make your discharge process successful, your healthcare members will provide you
                                    with all the information you need in the course of your being discharge. </p>
                                ...
                                <div class="margin-bottom">
                                    ...
                                    <ul class="square-list-type" id="squareList">
                                        ...
                                        <li>What medications do you need to take, including why, when, and how to take
                                            them, and what possible side effects to watch for.</li>
                                    ...
                                    <p>Ensure your discharge process includes all of the above, if it does not, make
                                        sure to ask. Get all your questions answered.</p>
                                </div>

                                <p>Once you have been discharged, carefully follow all the instructions from you
                                    healthcare provider.</p>
                                <p>Keep all of your follow-up appointments. When you go for an appointment, be ready to
                                    tell your healthcare provider how you have been feeling. Ask questions about any
                                    part of your recovery or care.</p>
