...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
            content="Our visitors information provide information such as visitation time, number of persons allows per visit at the final stage of life, when expecting a baby, etc" />
        <meta charset="UTF-8" />
                    ...
                    <div class="flex">
                        ...
                        <div class="column-right col-70">
                            <div class="margin-bottom">
                                ...
                                <div class="margin-bottom">
                                    ...
                                    <ul class="square-list-type" id="squareList">
                                        <li><b class="sky-blue">Staying in the hospital:</b> Only 2 visitors per visit
                                            are allowed, visiting time from 2 p.m. – 4 p.m. in the afternoon, and 6 p.m.
                                            - 7 p.m. in the evening. 1 overnight stay visitor is also allowed.</li>

                                        <li><b class="sky-blue">Within the Emergency Room:</b> 2 people are allowed at a
                                            time.</li>
                                        <li><b class="sky-blue">At clinic appointment:</b> 2-3 people are allowed per
                                            appointment. </li>
                                    </ul>
                                </div>
                                <div class="margin-bottom">
                            ...
                            <div>
                                ...
                                <p>If you want to find out more about visitors’ policy exceptions, talk to the patient's
                                    care team. They will review your request and guide you adequately.</p>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p>If you and your partner are expecting a baby, you can have <strong>2
                                            visitors</strong>, 24/7. </p>
                                </div>
                                <div>
                                    <h5 class="sky-blue">Clergy</h5>
                                    <p>Along with your permitted visitors, <strong>clergy members</strong> may visit
                                        you.</p>
                                </div>
                            </div>
                        </div>
