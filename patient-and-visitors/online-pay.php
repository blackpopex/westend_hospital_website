...
<html lang="en">
    ...
    <head>
        <title>Online Pay | Westend Hospital</title>
        <link rel="icon" type="image/x-icon" href="./img/logo/favicon.ico.png" />
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css" />
        <meta name="description"
            content="We offer a convenient and easy way to pay for medical care and services received at Westend Hospital. This service is offered every day of the week, round the clock. " />
        <meta charset="UTF-8" />
    ...
    <body>
        ...
        <main>
            <div class="section-background-image billing-and-finance">
                <div class="container">
                    <h2 class="subnavbar-color">Online Pay</h2>
                    <ul class="inline-block-breadcrumb subnavbar-color">
                        <li>
                            <a href="../index">Home</a>
                        </li>
                        <li>
                            <a href="billing-and-financial-asistance">Billing and Financial Assistance</a>
                        </li>
                        <li>online pay</li>
                    </ul>
                </div>
            ...
            <section id="Online-pay">
                <div class="container align-start">
                    <div class="flex align-start">
                        <!--Pay with paystack-->
                        <div class="column-left col-60">
                            <div class="payment-main-wrapper">
                                <!--Pay online for services redered-->
                                <h3 class="navy-blue">Welcome to our online payment portal.</h3>
                                <p>An easy and secure way to pay for your care.</p>
                                <div class="payment-wrapper">
                                    <div class="payment-image margin-bottom">
                                        <img src="../img/background-image/payment.jpg" alt="payment image" />
                                    </div>
                                    <h4 class="navy-blue">With our payment portal you can:</h4>
                                    <p>Pay your bill without setting up an online account</p>
                                    <div class="flex">
                                        <div class="master-verve-visa col-50">
                                            <h5 class="navy-blue">We Accept:</h5>
                                            <img src="../img/other photos/cards.png" alt="payment cards logo" />
                                        </div>
                                        <div class="secure-by col-50">
                                            <h5 class="navy-blue">Secured By:</h5>
                                            <img src="../img/other photos/paystack-logo-vector.png"
                                                alt="Paystack logo" />
                                        </div>
                                    </div>
                                    <h6 class="navy-blue">
                                        For help and support, call us at +234 (0) 807 420 2574,
                                        email us at account@thewestendhospital.com
                                    </h6>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-container">
                                <form action="" method="post" autocomplete="off" id="paymentForm">
                                    <div class="form-content">
                                        <h4 class="navy-blue">Payment Information</h4>
                                        ...
                                        <div class="flex">
                                            <div class="col-100">
                                                ...
                                                <select type="text" name="PaymentFor" id="payment-for" required
                                                    onchange="inputAmount()">
                                                    <option class="select_list uch" value="">
                                                        Select reason for payment
                                                    </option>
                                                    <option class="select_list uch" value="Ante-natal Registration">
                                                        Ante-natal Registration
                                                    </option>

                                                    <option class="select_list" value="Cardiology Consultation">
                                                        Cardiology Consultation
                                                    </option>
                                                    <option class="select_list" value="Cardiology Revisit">
                                                        Cardiology Revisit
                                                    </option>

                                                    <option class="select_list" value="Dermatology Consultation">
                                                        Dermatology Consultation
                                                    </option>
                                                    <option class="select_list" value="Dermatology Revisit">
                                                        Dermatology Revisit
                                                    </option>

                                                    <option class="select_list" value="Endocrinology Consultation">
                                                        Endocrinology Consultation
                                                    </option>
                                                    <option class="select_list" value="Endocrinology Revisit">
                                                        Endocrinology Revisit
                                                    </option>
                                                    <option class="select_list" value="ENT Consultation">
                                                        ENT Consultation
                                                    </option>

                                                    <option class="select_list" value="General Consultation">
                                                        General Consultation
                                                    </option>
                                                    <option class="select_list" value="Gynaecology Consultation">
                                                        Gynaecology Consultation
                                                    </option>
                                                    <option class="select_list" value="Gynaecology Revisit">
                                                        Gynaecology Revisit
                                                    </option>
                                                    <option class="select_list" value="Gastroenterology Consultation">
                                                        Gastroenterology Consultation
                                                    </option>
                                                    <option class="select_list" value="General Surgeon Consultation">
                                                        General Surgeon Consultation
                                                    </option>

                                                    <option class="select_list" value="Haematology Consultation">
                                                        Haematology Consultation
                                                    </option>

                                                    <option class="select_list" value="Neurology Consultation">
                                                        Neurology Consultation
                                                    </option>
                                                    <option class="select_list" value="Neurology Revisit">
                                                        Neurology Revisit
                                                    </option>
                                                    <option class="select_list" value="Neurosurgery Consultation">
                                                        Neurosurgery Consultation
                                                    </option>
                                                    <option class="select_list" value="Neurosurgery Revisit">
                                                        Neurosurgery Revisit
                                                    </option>
                                                    <option class="select_list" value="Nephrology Consultation">
                                                        Nephrology Consultation
                                                    </option>
                                                    <option class="select_list" value="Nephrology Revisit">
                                                        Nephrology Revisit
                                                    </option>

                                                    <option class="select_list" value="Orthopadic Consultation">
                                                        Orthopadic Consultation
                                                    </option>

                                                    <option class="select_list" value="Paediatrics Consultation">
                                                        Paediatrics Consultation
                                                    </option>
                                                    <option class="select_list" value="Pulmonology Consultation">
                                                        Pulmonology Consultation
                                                    </option>

                                                    <option class="select_list" value="Urology Consultation">
                                                        Urology Consultation
                                                    </option>
                                                    <option class="select_list" value="Urology Revisit">
                                                        Urology Revisit
                                                    </option>
                                                    <option class="select_list name" value="Others"
                                                        name="othersForInput" id="activate_input_field_for_value">
                                                        Others
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <!--Activated this when others is clicked on the dropdown using javascript-->
                                        <div class="flex set-hidden" id="openWhenOthersIsClicked">
                                            <div class="col-100">
                                                <label for="amount">Enter Reason for Payment: </label>
                                                <input type="text" name="Reason_for_payment" id="reasonForPayment" />
                                            </div>
                                        </div>

                                        <!--Activated this input field from disabled to enable so users can type in the amount using Javascript-->
                                        <div class="flex">
                                            <div class="col-100">
                                                <label for="amount" id="enterAmount">Amount to pay (NGN):
                                                </label>
                                                <input type="tel" name="Email" id="amount" disabled />
                                            </div>
                                        </div>
