      ...
      <div class="section-background-image billing-and-finance">
        <div class="container">
          ...
          <ul class="inline-block-breadcrumb subnavbar-color">
            ...
            <li>
              <a href="billing-and-financial-asistance.html"
                >Billing and Financial Assistance</a
              >
            </li>
            <li>online pay</li>
          </ul>
              ...
              <div class="payment-main-wrapper">
                ...
                <div class="payment-wrapper">
                  <div class="payment-image margin-bottom">
                    <img
                      src="../img/background-image/payment.jpg"
                      alt="payment image"
                    />
                  </div>
                  ...
                  <div class="flex">
                    <div class="master-verve-visa col-50">
                      ...
                      <img
                        src="../img/other photos/cards.png"
                        alt="payment cards logo"
                      />
                    </div>
                    <div class="secure-by col-50">
                      <h5 class="navy-blue">Secured By:</h5>
                      <img
                        src="../img/other photos/paystack-logo-vector.png"
                        alt="Paystack logo"
                      />
                    </div>
                  </div>
              ...
              <div class="form-container">
                ...
                >
                  <div class="form-content">
                    ...
                    <div class="flex">
                      <div class="col-100">
                        ...
                        >
                          ...
                          <option
                            class="select_list uch"
                            value="Ante-natal Registration"
                          >
                          ...
                          <option
                            class="select_list"
                            value="Endocrinology Consultation"
                          >
                            Endocrinology Consultation
                          </option>
                          <option
                            class="select_list"
                            value="Endocrinology Revisit"
                          >
                          ...
                          <option
                            class="select_list"
                            value="Gynaecology Consultation"
                          >
                            Gynaecology Consultation
                          </option>
                          <option
                            class="select_list"
                            value="Gynaecology Revisit"
                          >
                            Gynaecology Revisit
                          </option>
                          <option
                          ...
                          <option
                            class="select_list"
                            value="General Surgeon Consultation"
                          >
                          ...
                          <option
                            class="select_list"
                            value="Haematology Consultation"
                          >
                          ...
                          <option
                            class="select_list"
                            value="Neurosurgery Revisit"
                          >
                            Neurosurgery Revisit
                          </option>
                          <option
                            class="select_list"
                            value="Nephrology Consultation"
                          >
                            Nephrology Consultation
                          </option>
                          <option
                            class="select_list"
                            value="Nephrology Revisit"
                          >
                            Nephrology Revisit
                          </option>
                          ...
                          <option
                            class="select_list"
                            value="Paediatrics Consultation"
                          >
                            Paediatrics Consultation
                          </option>
                          <option
                            class="select_list"
                            value="Pulmonology Consultation"
                          >
                          ...
                          <option
                            class="select_list name"
                            value="Others"
                            name="othersForInput"
                            id="activate_input_field_for_value"
                          >
                            Others
                          </option>
                        </select>
                    ...
                    <div class="flex">
                      <div class="col-100">
                        <label for="amount" id="enterAmount"
                          >Amount to pay (NGN):
                        </label>
