...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Your hospital stay must start with registration and admission. Know what to bring with you when you come for admission, learn more about the room you will be admitted into, learn more about visiting hours, and know what to expect when you are discharged. "/>
        <meta charset="UTF-8"/>
                    ...
                    <div
                                ...
                                <div class="column-left">
                                    ...
                                    <div class="quick-links">
                                        <div>
                                            ...
                                            <ul>
                                                <li><a href="./your-hospital-stay/registration-and-admitting-process.html">Registration and Admitting process</a></li>
                                                <li><a href="./your-hospital-stay/what-to-bring-with-you.html">What to bring with you</a></li>
                                                <li><a href="./your-hospital-stay/your-room-and-unit.html">Your room and unit</a></li>
                                                <li><a href="./your-hospital-stay/visitors-information.html">Visitors information</a></li>
                                                <li><a href="./your-hospital-stay/going-home-discharge.html">Going home/discharge</a></li>
                                            </ul>
                                        </div>
                        ...
                        <div class="column-right col-70">
                            <div>
                                ...
                                <p>Staying in the hospital can sometimes seem stressful and uncomfortable for you and your loved ones. No one enjoys spending time in the hospital but few resources make ones stay compelling. The following guidelines <b>on the step to follow</b> were developed to make your hospital stay as comfortable and smooth as possible.
                                </p>

                                <p>This detailed guideline <b>on the step to follow</b> was gotten from patients’ suggestions about making their stay comfortable using good practices in the hospital and beyond to improve patients' overall experience.
                                </p>
                    ...
                    <div class="flex lg-size">
                        ...
                        <div>
                            ...
                            <div class="ways-to-help footer-header">
                                <h4>Ways to Help</h4>
                                <p>
                                    We supports Father's Heart Children's Trust, see how you can  make the lives of Orphans in Delta State better.
                                </p>
