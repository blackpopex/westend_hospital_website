...
<html lang="en">
    <head>
        <title>
            Going Home and Discharge | Westend Hospital 
        </title>
        <link rel="icon" type="image/x-icon" href="./img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content=" A hospital discharge is a process where you no longer need to receive inpatient care and can go home to continue care. Before your discharge, it is important to make a list of all your possible questions. Take note of your care team's reply and ensure all question asked is adequately answered. "/>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <main>
            <div class="section-background-image registration-and-admitting">
                <div class="container">
                    <h2 class="subnavbar-color">Going Home & Discharge</h2>
                    <ul class="inline-block-breadcrumb subnavbar-color">
                        ...
                        <li>Going home and Discharge</li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="flex">
                        ...
                        <div
                            ...
                            <div class="margin-bottom">
                                ...
                                <p>To make your discharge process successful, your healthcare members will provide you with all the information you need in the course of your being discharge.                                </p>
                               
                                 <div class="margin-bottom">
                                     <h5 class="navy-blue">Things your medical team will discuss with you include:</h5>
                                    <ul class="square-list-type" id="squareList">
                                                <li>Your medical condition at the time of discharge.</li>
                                                <li>What kinds of follow-up care you will need, such as physical therapy.</li>
                                                <li>What medications do you need to take, including why, when, and how to take them, and what possible side effects to watch for.</li>
                                                <li>What medical equipment you will need, and how to get it.</li>
                                                <li>Phone numbers to call if you have a question or problem.</li>
                                            </ul>
                                            <p>Ensure your discharge process includes all of the above, if it does not, make sure to ask. Get all your questions answered.</p>
                                 </div>

                                 <p>Once you have been discharged, carefully follow all the instructions from you healthcare provider.</p>
                                 <p>Keep all of your follow-up appointments. When you go for an appointment, be ready to tell your healthcare provider how you have been feeling. Ask questions about any part of your recovery or care.</p>
