...
<html lang="en">
    <head>
        <title>
            What to bring with you | Westend Hospital
        </title>
        <link rel="icon" type="image/x-icon" href="./img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="For your convenience, we advise that you come along with a few personal belongings that will make you stay comfortable while at Westend Hospital."/>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <main>
            <div class="section-background-image registration-and-admitting">
                <div class="container">
                    <h2 class="subnavbar-color">What To Bring With You</h2>
            ...
            <section id="what-to-bring-with-you">
                    ...
                    <div class="flex">
                        ...
                        <div
                            ...
                            <div class="margin-bottom">
                                <p>
                                    For your convenience, we advise that you come along with a few personal belongings that will make you stay comfortable while at Westend Hospital.  
                                </p>
                               
                                 <div class="margin-bottom">
                                     <h5 class="navy-blue">Kindly come with the following:</h5>
                                     <ul class="square-list-type" id="squareList">
                                                ...
                                                <li>A list of all medications you are currently taking</li>
                                            </ul>
                                 </div>


                                 <div class="margin-bottom">
                                     <h5 class="navy-blue">Do not come with the following:</h5>
                                     <ul class="square-list-type" id="squareList">
                                                <li>Jewelry</li>
                                                <li>Large sums of cash</li>
                                ...
                                <div class="margin-bottom">
                                    <h5 class="navy-blue">Your medications list</h5>
                                    
                                    <p>Kindly come with a list of all medications you are presently taking. To receive optimum care, it is crucial that we know about both prescriptions and over-the-counter medications you take. </p>
                                    <p>Inform us if you have any food or drug allergies and what kind of allergic reaction you experience. It is important that we have all this information so that you can receive the safest and most valuable care.</p>
                                </div>
                            </div>
                        </div>
                    </div>
