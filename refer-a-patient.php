...
<html lang="en">
    <head>
        <title>
            Refer a patient | Westend Hospital
        </title>
        <link rel="icon" type="image/x-icon" href="img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="Are you looking for the best medical care for your patient, why not refer to us? At Westend Hospital we handle the most complex cases and we keep the referring doctors informed about how their patients' treatments are doing."/>
        <meta charset="UTF-8"/>
                        ...
                        <div class="form-container col-70">
                            <div class="wrapper">
                                <div>
                                    ...
                                    <p>If your preferred choice is to refer through a phone call, please dial  <span class="sky-blue">+234 (0) 807 420 2395</span> for patients' referrals and medical transfers. 
...
</section></footer><script src="js/main.js"></script><script src="js/jquery-3.2.1.min.js" type="text/javascript"></script><script src="js/slick.js" type="text/javascript"></script>
