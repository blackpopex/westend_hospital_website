...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
            content="Please use the links below to swiftly navigate to different pages on this website." />
        <meta charset="UTF-8" />
                                    ...
                                    <ul class="flex navBar1">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-content" id="menuDropdown">
                                                <li>
                                                    <a href="medical-test-and-services/A-Z-of-all-medical-test">A-Z of
                                                        all Medical Test</a>
                                                </li>
                                                <li>
                        ...
                        <div class="align-start flex">
                            <div class="col-30">
                                <div class="margin-bottom">
                                    ...
                                    <ul>
                                        <li><a href="/medical-test-and-services/A-Z-of-all-medical-test">A-Z of all
                                                Medical Test</a></li>
                                        <li><a href="/medical-test-and-services/A-Z-of-all-medical-services">A-Z of all
                                                Medical Services</a></li>
                                        <li><a href="/medical-test-and-services/department-and-services">Department and
                                                Services</a></li>
                                        <li><a href="/medical-test-and-services/patient-education">Patient Education</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="margin-bottom">
                                    ...
                                    <ul>
                                        <li><a
                                                href="./patient-and-visitors/inpatient/registration-and-admitting-process">Registration
                                                & Admitting process</a></li>
                                        <li><a href="./patient-and-visitors/inpatient/what-to-bring-with-you">What
                                                to bring with you</a></li>
                                        <li><a href="./patient-and-visitors/inpatient/your-room-and-unit">Your
                                                Room and Unit</a></li>
                                        <li><a href="./patient-and-visitors/inpatient/visitors-information">Visitors
                                                Information</a></li>
                                        <li><a href="./patient-and-visitors/inpatient/going-home-discharge">Going
                                                Home/Discharge</a></li>
                                    </ul>
                                </div>
                                <div class="margin-bottom">
                                    ...
                                    <ul>
                                        <li><a href="./patient-and-visitors/accepted-insurance">Insurance
                                                Information</a>
                                        </li>
                            ...
                            <div class="col-30">
                                <div class="margin-bottom">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="./patient-and-visitors/your-hospital-stay">Your Hospital Stay</a>
                                        </li>
                                        <li><a href="./patient-and-visitors/billing-and-financial-asistance">Billing and
                                                Financial Asistance</a></li>
                                        <li><a href="./patient-and-visitors/accepted-insurance">Accepted Insurance</a>
                                        </li>
                            ...
                            <div class="col-30">
                                <div class="margin-bottom move-downwards-on-mobile">
                                    ...
                                    <ul>
                                        <li><a href="/why-choose-us/our-mission-vision-and-values">Our Mission, Vision &
                                                Values</a></li>
                                        <li><a href="/why-choose-us/quality-patient-care">Quality Patient Care</a></li>
                                        <li><a href="/why-choose-us/patient-stories-testimonies">Patient's
                                ...
                                <div class="margin-bottom">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="medical-test-and-services/patient-support-services/nursing">For
                                                Nurses</a></li>
                    ...
                    <div class="margin-bottom">
                        ...
                        <div class="align-start flex col-50">
                            <div class="col-30 move-upwards-on-largescreen">
                                ...
                                <ul>
                                    <li><a
                                            href="medical-test-and-services/clinical-departments/anesthesiology-and-perioperative">Anaesthesiology
                                            & Perioperative</a></li>
                                    <li><a
                                            href="medical-test-and-services/clinical-departments/audiometry">Audiometry</a>
                                    </li>
                                    <li><a href="medical-test-and-services/clinical-departments/emergency-medicine">Emergency
                                            Medicine</a></li>
                                    <li><a href="medical-test-and-services/clinical-departments/ear-nose-and-throat">Ear,Nose
                                            & Throat</a></li>
                                    <li><a href="medical-test-and-services/clinical-departments/geriatric">Geriatric</a>
                                    </li>
                                    <li><a href="#/">Immunization</a></li>
                                    <li><a
                                            href="medical-test-and-services/clinical-departments/laboratory">Laboratory</a>
                                    </li>
                                    <li><a href="medical-test-and-services/clinical-departments/molecular">Molecular</a>
                                    </li>
                                    <li><a
                                            href="medical-test-and-services/clinical-departments/obstetrics-and-gynecology">Obstetrics
                                            & Gynecology</a></li>
                                    <li><a href="medical-test-and-services/clinical-departments/pharmacy">Pharmacy</a>
                                    </li>
                                    <li><a
                                            href="medical-test-and-services/clinical-departments/physiotherapy">Physiotherapy</a>
                                    </li>
                                    <li><a href="medical-test-and-services/clinical-departments/radiology">Radiology</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-30 move-upwards-on-largescreen">
                                ...
                                <ul>
                                    <li><a href="medical-test-and-services/patient-support-services/account">Account</a>
                                    </li>
                                    <li><a href="medical-test-and-services/patient-support-services/client-relations">Client
                                            Relations</a></li>
                                    <li><a href="#/">Insurance</a></li>
                                    <li><a href="medical-test-and-services/patient-support-services/nursing">Nursing</a>
                                    </li>
                                    <li><a href="medical-test-and-services/patient-support-services/medical-records">Medical
                                            Record</a></li>
                                    <li><a
                                            href="medical-test-and-services/patient-support-services/occupational-health">Occupational
                                            Health</a></li>
                                    <li><a
                                            href="medical-test-and-services/patient-support-services/out-patient-department">Outpatient
                                            Department</a></li>
                                    <li><a
                                            href="medical-test-and-services/patient-support-services/supermart">Supermart</a>
                                    </li>
                                    <li><a
                                            href="medical-test-and-services/patient-support-services/cafeteria">Cafeteria</a>
                                    </li>
                                    <li><a
                                            href="medical-test-and-services/patient-support-services/security">Security</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
