...
<html lang="en">
    ...
    <head>
        <title>
            Our Team | Westend Hospital
        </title>
        <link rel="icon" type="image/x-icon" href="../img/logo/favicon.ico.png" />
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css" />
        <meta name="description"
            content="Our team at Westend Hospital consists of Management, Medical, Administrative, and Security. These team members are led by the hospital's objective to provide all Deltans and residents of neighboring states and communities with innovative, high-quality family-centered care. " />
        <meta charset="UTF-8" />
    ...
    <body>
                                    ...
                                    <ul class="flex navBar1">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-content" id="menuDropdown">
                                                ...
                                                <li>
                                                    <a href="../why-choose-us/leardership">Our Team</a>
                                                </li>
                                            </ul>
                                        </li>
        ...
        <main>
            <div class="section-background-image out-team">
                <div class="container">
                    <h2 class="subnavbar-color">Our Team</h2>
                ...
                <div class="container align-start column-reverse">
                    <div class="flex">
                            ...
                            <aside>
                                ...
                                <div class="column-left">
                                    ...
                                    <div class="quick-links">
                                        <div>
                                            <h4 class="navy-blue">Team Members</h4>
                                            <ul>
                                                <li><a href="./leardership/management-team">Management Team</a></li>
                                                <li><a href="./leardership/medical-team">Medical Team</a></li>
                                                <li><a href="./leardership/administrative-team">Adminstrative Team</a>
                                                </li>
                                        ...
                                        <div>
                                            ...
                                            <ul>
                                                <li><a href="../why-choose-us/our-mission-vision-and-values">Our
                                                        Mission, Vision & Values</a></li>
                                                <li><a href="../why-choose-us/quality-patient-care">Quality Patient
                                                        Care</a></li>
                                                <li><a href="../why-choose-us/patient-stories-testimonies">Patient
                                                        Stories/Testimonies</a></li>
                                                <li><a href="../why-choose-us/leardership">Our Team</a></li>
                        ...
                        <div class="column-right col-70">
                            <div>
                                <p>The team at Westend Hospital is led by the hospital's objective to provide all
                                    Deltans and residents of neighboring states and communities with innovative,
                                    high-quality family-centered care.
                                    No matter their race, color, tribe, religion, national origin, disability, age, or
                                    financial situation, the members of our team are committed to helping every patient
                                    achieve the maximum degree of health.
                                </p>
                            </div>
                            ...
                            <div class="billing-topics-container  margin-top">
                                <h3 class="navy-blue">Team Profile By Category</h3>
                                <!--Accordions-->
                                <div class="accordion-wrapper">
                                    <!--MANAGEMENT TEAM-->
                                    <h4 class="accordion navy-blue">Management</h4>
                                    <div class="accordion-content" id="menuDropdown">
                                        <div class="margin-bottom">
                                            <p>The Management team sets policy and ensures that the department heads and
                                                supervisor work in line with the set policy. It makes major decisions in
                                                consultation with senior clinical staff.
                                            </p>
                                            <p>The Management team is made up of the Chairman, who heads a team of 5
                                                full-time professionals which includes the Medical Director, Operations
                                                Manager, Head of Account, Human Resource Manager, and Client Relations
                                                Manager, these team members know and represent the interests of the
                                                Hospital.</p>
                                            <p>They work in collaboration with department heads to ensure that we
                                                deliver services that reflect the needs of our patients and the local
                                                community. They are primarily involved in determining the hospital's
                                                plans.</p>

                                            <div class="accepted-insurance margin-bottom">
                                                <a href="leardership/management-team"
                                                    class="btn white-background-sky-blue-border sky-blue">View Team
                                                    Members</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!--MEDICAL TEAM-->
                                    <h4 class="accordion navy-blue">Medical </h4>
                                    <div class="accordion-content" id="menuDropdown">
                                        <div class="margin-bottom">
                                            <div>
                                                <p>The medical team comprises of professionals who contribute to
                                                    patients’ care and treatment. Members of our medical team include
                                                    but are not limited to Surgeons, Physicians, Radiologists,
                                                    Dermatologists, Pediatricians, Registered Nurses, Obstetricians and
                                                    gynecologists, Radiographers, Laboratory scientists, etc. </p>
                                                <p>They are charged with the responsibility of providing primary,
                                                    secondary, and in some cases, tertiary healthcare services in the
                                                    core clinical fields of surgery, obstetrics and gynecology,
                                                    medicine, and pediatrics.</p>
                                            </div>
                                            <div class="accepted-insurance margin-bottom">
                                                <a href="leardership/medical-team"
                                                    class="btn white-background-sky-blue-border sky-blue">View Team
                                                    Members</a>
                                            </div>
                                    ...
                                    <div class="light-grey-border"></div>
                                    <!--ADMINISTRATIVE-->
                                    <h4 class="accordion navy-blue">Administrative</h4>
                                    <div class="accordion-content" id="menuDropdown">
                                        <p class="margin-bottom">The administrative team provides support to both
                                            clinical and non-clinical staff, they are charged with duties such as
                                            administration, posting of staff, training, promotion, stationeries,
                                            preparing and keeping financial and medical records, etc.</p>
                                        <p>Additionally, our administrative personnel are in charge of planning and
                                            guaranteeing the efficient operation of all activities in our healthcare
                                            center. Among other things, they make sure patients receive proper care.</p>

                                        <div class="accepted-insurance margin-bottom">
                                            <a href="leardership/administrative-team"
                                                class="btn white-background-sky-blue-border sky-blue">View Team
                                                Members</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="light-grey-border"></div>
                                    <!--SECURITY-->
                                    <h4 class="accordion navy-blue">Security
                                    </h4>
                                    <div class="accordion-content" id="menuDropdown">

                                        <div class="margin-bottom">
                                            <p>The protection and safety of the hospital's assets, employees, and
                                                patients, as well as traffic control on hospital grounds, are the
                                                responsibility of our security staff. </p>
                                            <p>Considering how difficult it is to spot any antisocial elements in a
                                                gathering or predict anyone's intentions. Therefore, undesired events
                                                like fights, boisterous scenes, accidents, or thefts may happen within
                                                hospitals; as a result, we are staffed with professional security
                                                officers to handle such problems.</p>
                                            <p>In order to ensure that hospital operations run efficiently and without
                                                interruption, security services' responsibility is to prevent and
                                                resolve any security breach.</p>
                                        </div>
                                        <div class="accepted-insurance margin-bottom">
                                            <a href="#/" class="btn white-background-sky-blue-border sky-blue">View Team
                                                Members</a>
                                        </div>
                                    </div>
                                    <div class="light-grey-border"></div>
