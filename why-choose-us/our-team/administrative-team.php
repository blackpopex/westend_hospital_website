...
<html lang="en">
  <head>
    <title>Administrative Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
  ...
  <body>
    ...
    <main>
      <div class="section-background-image out-team">
        <div class="container">
          <h2 class="subnavbar-color">Administrative Team</h2>
        ...
        <div class="container align-start column-reverse">
          <div class="flex">
                ...
                <div class="column-left">
                  <div class="quick-links">
                    ...
                    <div>
                      ...
                      <ul>
                        <li>
                          <a href="our-mission-vision-and-values.html"
                            >Our Mission, Vision & Values</a
                          >
                        </li>
                        <li>
                          <a href="quality-patient-care.html"
                            >Quality Patient Care</a
                          >
                        </li>
                        <li>
                          <a href="patient-stories-testimonies.html"
                            >Patient Stories/Testimonies</a
                          >
                        </li>
            ...
            <div class="column-right col-70">
              <div>
                <h3 class="navy-blue">Administrative Team</h3>
                ...
                <div class="article-container flex">
                  ...
                  <div class="profile article-box col-30">
                    <img
                      src="../../img/team-members/administrative-team/Inana-E.-Jude.jpg"
                      alt="Inana-E.-Jude"
                    />
                    <div class="title transparent-sky-blue">
                      <h4>Mr. Inana E. Jude</h4>
                    </div>
                    <div class="article-content lighter-blue-bg">
                      <h6 class="navy-blue">Head of Account</h6>
                      <p>
                        He is the current group head of accounts at Westend...
                      </p>
                      <a
                        href="./administrative-team/Inana-Jude.html"
                        class="skyblue float-right"
                        >View Profile
                  ...
                  <div class="profile article-box col-30">
                    <img
                      src="../../img/team-members/administrative-team/Rita-Torru.jpg"
                      alt="Rita-Torru"
                    />
                    <div class="title transparent-navy-blue">
                      <h4>Mrs. Rita Torru</h4>
                    </div>
                    <div class="article-content lighter-blue-bg">
                      <h6 class="navy-blue">Operations Manager</h6>

                      <p>
                        She is currently working in the capacity of
                        Operations...
                      </p>
                      <a
                        href="./administrative-team/Rita-Torru.html"
                        class="skyblue float-right"
                        >View Profile
                        <i class="fa fa-angle-right"></i>
                      </a>
                  ...
                  <div class="profile article-box col-30">
                    <img
                      src="../../img/team-members/administrative-team/E.-O.-Daphney.jpg"
                      alt="E.-O.-Daphney"
                    />
                    <div class="title transparent-sky-blue">
                      <h4>Mrs. E. O. Daphney</h4>
                    </div>
                    <div class="article-content lighter-blue-bg">
                      <h6 class="navy-blue">H.R. Manager</h6>
                      <p>She has been working with Westend Hospital for 5...</p>
                      <a
                        href="./administrative-team/Esevwiegbe-Daphney.html"
                        class="skyblue float-right"
                        >View Profile
                        <i class="fa fa-angle-right"></i>
                      </a>
                  ...
                  <div class="profile article-box col-30">
                    <img
                      src="../../img/team-members/administrative-team/George-C.-Aham.jpg"
                      alt="George-C.-Aham"
                    />
                    <div class="title transparent-navy-blue">
                      <h4>Mr. George C. Aham</h4>
                    </div>
                    <div class="article-content lighter-blue-bg">
                      <h6 class="navy-blue">Client Relations Manager</h6>
                      <p>He is the Client Relations Manager at Westend...</p>
                      <a
                        href="./administrative-team/George-Aham.html"
                        class="skyblue float-right"
                        >View Profile
                        <i class="fa fa-angle-right"></i>
                      </a>
                  ...
                  <div class="profile article-box col-30">
                    <img
                      src="../../img/team-members/administrative-team/Omoshowo-Akenuwa.jpg"
                      alt="Omoshowo-Akenuwa O."
                    />
                    <div class="title transparent-sky-blue">
                      <h4 class="small-font-size-name">Omoshowo-Akenuwa O.</h4>
                    </div>
                    <div class="article-content lighter-blue-bg">
                      <h6 class="navy-blue">Head of Insurance</h6>

                      <p>She is the current head of the department of...</p>
                      <a
                        href="./administrative-team/Omoshowo-Akenuwa-Osariemen.html"
                        class="skyblue float-right"
                        >View Profile
                        <i class="fa fa-angle-right"></i>
                      </a>
                  ...
                  <div class="profile article-box col-30">
                    <img
                      src="../../img/team-members/administrative-team/Osezele-Jennifer.jpg"
                      alt="Osezele-Jennifer"
                    />
                    <div class="title transparent-navy-blue">
                      <h4>Ms. Osezele Jennifer</h4>
                    </div>
                    <div class="article-content lighter-blue-bg">
                      <h6 class="navy-blue">Front Desk Supervisor</h6>
                      <p>An occupational Health Supervisor at Westend...</p>
                      <a
                        href="./administrative-team/Osezele-Jennifer.html"
                        class="skyblue float-right"
                        >View Profile
                        <i class="fa fa-angle-right"></i>
                      </a>
                  ...
                  <div class="profile article-box col-30">
                    <img
                      src="../../img/team-members/administrative-team/Cynthia-C-Obi-2.jpg"
                      alt="Cynthia-C-Obi-2"
                    />
                    <div class="title transparent-sky-blue">
                      <h4>Ms. Cynthia C. Obi</h4>
                    </div>
                    <div class="article-content lighter-blue-bg">
                      <h6 class="navy-blue">Head of Outpatient Dept.</h6>
                      <p>An occupational Health Supervisor at Westend...</p>
                      <a
                        href="./administrative-team/Cynthia-C-Obi.html"
                        class="skyblue float-right"
                        >View Profile
                        <i class="fa fa-angle-right"></i>
                      </a>
