...
<html lang="en">
  <head>
    <title>Ms. Cynthia C. Obi - Administrative Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/administrative-team/Cynthia-C-Obi.jpg"
            alt="Cynthia-C-Obi"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Ms. Cynthia C. Obi</h2>
            <h4 class="navy-blue">Head of Outpatient Department</h4>

            <div class="icon-contact-number flex navy-blue">
              <i class="fa fa-phone-alt"></i>
              <p>+234 (0) 807 424 1978</p>
            </div>
          ...
          <div class="flex">
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  Cynthia C. Obi is currently the head of the outpatient
                  department, her journey with the hospital began in 2019 when
                  she was an administrative assistant, later promoted in January
                  2022 to the post of outpatient department head due to her
                  unweaving dedication to her job. She holds a Bachelor of
                  Science degree in Economics from Anambra State University.
                </p>
                <p>
                  Her strength includes self-motivation, and inquiring mind that
                  possesses proven adaptability, target-oriented, career driven,
                  analytical, and problem-solving, always ready to face
                  challenges when they arise.
                </p>
                <p>
                  As the head of the administrative department, her duties
                  include but are not limited to:
                </p>
                <ul class="square-list-type" id="squareList">
                  <li>
                    Supervised and collaborated with 9 team members to
                    coordinate office activities and operations.
                  </li>
                  <li>
                    Leads departmental meetings and contributes to methods to
                    improve the quality of hospital operations.
                  </li>
                  <li>
                    Prepare and supervise work schedules to ensure proper and
                    adequate shift coverage at all times.
                  </li>
                  <li>Resolve potential issues with patients.</li>
                  <li>
                    Training new team members on administrative processes,
                    company requirements, and performance strategies.
                  </li>
