...
<html lang="en">
  <head>
    <title>Mr. Inana E. Jude - Administrative Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/administrative-team/Inana-E.-Jude.jpg"
            alt="Inana-E.-Jude"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Mr. Inana E. Jude.</h2>
            <h4 class="navy-blue">Head of Account</h4>

            <div class="icon-contact-number flex navy-blue">
              <i class="fa fa-phone-alt"></i>
              <p>+234 (0) 807 734 4853</p>
            </div>
          ...
          <div class="flex">
              ...
              <div class="profile-detail-wrapper">
                ...
                <div class="margin-bottom">
                  ...
                  <ul>
                    ...
                    <li>Catholic Men's Organization of Nigeria (C.M.O.)</li>
                  </ul>
                </div>
                <div class="margin-bottom">
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  He is the current group head of accounts at Westend Hospital
                  and its affiliate. He ensures financial planning and accounts
                  for the group.
                </p>
                <p>
                  He oversees the strategic financial implementation of the
                  group. He has been with the hospital for more than 3 years. He
                  has served in various capacities both within and outside the
                  hospital such as head of group planning and budgeting, Head of
                  the committee for the implementation of hospital software
                  (insta), and head of the committee for the implementation of a
                  paperless system.
                </p>
                <p>
                  He holds a bachelor’s degree in accounting and a master’s in
                  finance from the University of Benin and also holds a
                  professional certificate from the prestigious institute of
