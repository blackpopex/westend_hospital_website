...
<html lang="en">
  <head>
    <title>
      Mrs.Omoshowo-Akenuwa Osariemen - Administrative Team | Westend Hospital
    </title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/administrative-team/Omoshowo-Akenuwa.jpg"
            alt="Omoshowo-Akenuwa"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Mrs. Omoshowo-Akenuwa O.</h2>
            <h4 class="navy-blue">Head of Insurance</h4>

            <div class="icon-contact-number flex navy-blue">
              <i class="fa fa-phone-alt"></i>
              <p>+234 (0) 807 420 3063</p>
            </div>
            ...
            <ul class="inline-block-breadcrumb subnavbar-color">
              ...
              <li>Omoshowo-Akenuwa Osariemen</li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div class="flex">
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  She is the current head of the department of Insurance and has
                  being working with Westend Hospital since Feb 2014. Over the
                  years, while working for the hospital, she has come to
                  understand the role of health insurance and how crucial they
                  are in terms of providing insurance coverage for staff of
                  various establishment and retirees. Her duties as the
                  department head are ensuring patients have a seamless service
                  in the facility under their respective insurance coverage. She
                  also plays a key role in expediting the approval process for
                  various investigations, especially in cases where they may be
                  delays on the part of the insurance company which in turn
                  saves patients’ waiting time.
                </p>
                <p>
                  Her remarkable years of experience have earned her continuous
                  professional development, good customer service, team
                  building/conflict resolution, and leadership management.
                </p>
              </div>
            </div>
          </div>
