...
<html lang="en">
  <head>
    <title>Ms. Osezele Jennifer - Administrative Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/administrative-team/Osezele-Jennifer.jpg"
            alt="Osezele-Jennifer"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Ms. Osezele Jennifer</h2>
            <h4 class="navy-blue">Front Desk Supervisor</h4>
          ...
          <div class="flex">
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  An Occupational Health and a Front Desk Supervisor at Westend
                  Hospital. Her responsibilities as a front desk supervisor
                  include training and supervising front desk teams, ensuring
                  all clients/customers are comfortable with their experience.
                </p>
                <p>
                  As an occupational health supervisor, she ensures proper
                  documentation of fitness to work medicals carried out for
                  clients and makes sure they align with Chevron, Shell, and
                  other company criteria as the case may be. She also oversees
                  the activities of other members of the Occupational Health
                  department including technicians.
                </p>
                <p>
                  Her exceptional customer service skills and content creation
                  has improved the hospital’s appearance both inwardly and
                  outwardly.
                </p>
              </div>
            </div>
