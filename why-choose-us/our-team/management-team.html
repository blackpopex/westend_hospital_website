...
<html lang="en">
  <head>
    <title>Management Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
  ...
  <body>
    ...
    <main>
      <div class="section-background-image out-team">
        <div class="container">
          <h2 class="subnavbar-color">Management Team</h2>
        ...
        <div class="container align-start column-reverse">
          <div class="flex">
            ...
            <div class="column-right col-70">
              <div>
                <h3 class="navy-blue">Management Team</h3>
                ...
                <div class="article-container flex">
                  ...
                  <div class="profile article-box col-30">
                    <img
                      src="../../img/team-members/management-team/Johnny-Amadasun.jpg"
                      alt="Johnny Amadasun"
                    />
                    <div class="title transparent-navy-blue">
                      <h4>Pharm. John Amadasun</h4>
                    </div>
                    <div class="article-content lighter-blue-bg">
                      <h6 class="navy-blue">Chairman</h6>

                      <p>He is the chairman of Westend, Safari Pharmacy...</p>
                      <a
                        href="./management-team/Johnny-Amadasun.html"
                  ...
                  <div class="profile article-box col-30">
                    <img
                      src="../../img/team-members/management-team/Felix-Ngwuli.jpg"
                      alt="Felix-Ngwuli"
                    />
                    ...
                    <div class="article-content lighter-blue-bg">
                      ...
                      <p>Dr. Felix Ngwuli is a Medical Director of...</p>
                      <a
                        href="./management-team/Felix-Ngwuli.html"
                        class="skyblue float-right"
                        >View Profile
                        <i class="fa fa-angle-right"></i>
                      </a>
                  ...
                  <div class="profile article-box col-30">
                    <img
                      src="../../img/team-members/management-team/Rita-Torru.jpg"
                      alt="Rita-Torru"
                    />
                    <div class="title transparent-navy-blue">
                    ...
                    <div class="article-content lighter-blue-bg">
                      ...
                      <p>She is currently working in the capacity of...</p>
                      <a
                        href="./management-team/Rita-Torru.html"
                        class="skyblue float-right"
                        >View Profile
                        <i class="fa fa-angle-right"></i>
                      </a>
                  ...
                  <div class="profile article-box col-30">
                    <img
                      src="../../img/team-members/management-team/Inana-E.-Jude.jpg"
                      alt="Inana-E.-Jude"
                    />
                    <div class="title transparent-sky-blue">
                    ...
                    <div class="article-content lighter-blue-bg">
                      ...
                      <p>He is the current group head of accounts at...</p>
                      <a
                        href="./management-team/Inana-Jude.html"
                        class="skyblue float-right"
                        >View Profile
                        <i class="fa fa-angle-right"></i>
                      </a>
                  ...
                  <div class="profile article-box col-30">
                    <img
                      src="../../img/team-members/management-team/E.-O.-Daphney.jpg"
                      alt="E.-O.-Daphney"
                    />
                    <div class="title transparent-navy-blue">
                    ...
                    <div class="article-content lighter-blue-bg">
                      ...
                      <p>She has been working with Westend Hospital for...</p>
                      <a
                        href="./management-team/Esevwiegbe-Daphney.html"
                        class="skyblue float-right"
                        >View Profile
                        <i class="fa fa-angle-right"></i>
                      </a>
                  ...
                  <div class="profile article-box col-30">
                    <img
                      src="../../img/team-members/management-team/George-C.-Aham.jpg"
                      alt="George-C.-Aham"
                    />
                    <div class="title transparent-sky-blue">
                    ...
                    <div class="article-content lighter-blue-bg">
                      ...
                      <a
                        href="./management-team/George-Aham.html"
                        class="skyblue float-right"
                        >View Profile
                        <i class="fa fa-angle-right"></i>
                      </a>
