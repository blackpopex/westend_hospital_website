...
<html lang="en">
  <head>
    <title>
      Mrs. Esevwiegbe Oghenefegor Daphney- Management Team | Westend Hospital
    </title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/management-team/E.-O.-Daphney.jpg"
            alt="E.-O.-Daphney"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Mrs. Esevwiegbe O. Daphney</h2>
            <h4 class="navy-blue">
              Human Resources Manager/ Front Desk Unit Head
            </h4>

            <div class="icon-contact-number flex navy-blue">
              <i class="fa fa-phone-alt"></i>
              <p>+234 (0) 807 420 8607</p>
            </div>
          ...
          <div class="flex">
            ...
            <div class="column-left col-30">
              <div class="profile-detail-wrapper">
                ...
                <div class="margin-bottom">
                  ...
                  <ul>
                    <li>Nigeria Institute of Management (NIM)</li>
                  </ul>
                </div>
                <div class="margin-bottom">
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  She has been working with Westend Hospital for 5 years in
                  varying capacities and currently working as the Human
                  Resources Manager/Front Desk Unit Head. Her duties cut across
                  several aspects of human resources including recruitment,
                  employee training, incentives, benefits, and payroll.
                </p>
                <p>
                  As a front desk unit head, she is responsible for the
                  day-to-day operations and supervision of all front desk teams
                  in providing a high level of customer service and assistance
                  to clients and preparing routine correspondence,
                  documentation, forms notices, or statistical reports. She had
                  undergone various training including: -
                </p>
                <ul class="square-list-type" id="squareList">
                  <li>Human Resources Management.</li>
                  <li>Diploma in Human Resources.</li>
                  <li>Customer Services Training.</li>
                  <li>Diploma in implementing customers care in management.</li>
                </ul>
              </div>
            </div>
          </div>
