...
<html lang="en">
  <head>
    <title>Dr. Felix-Ngwuli - Management Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/medical-team/Felix-Ngwuli.jpg"
            alt="Felix-Ngwuli"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Dr. Felix Ngwuli</h2>
            <h4 class="navy-blue">Medical Director</h4>

            <div class="icon-contact-number flex navy-blue">
              <i class="fa fa-phone-alt"></i>
              <p>+234 (0) 807 420 2395</p>
            </div>
          ...
          <div class="flex">
            ...
            <div class="column-left col-30">
              <div class="profile-detail-wrapper">
                ...
                <div class="margin-bottom">
                  ...
                  <ul>
                    <li>Bacherlor of Medicine, Bachelor of Surgery</li>
                  </ul>
                </div>
                <div class="margin-bottom">
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  Dr. Felix Ngwuli is a Medical Director of Westend Hospital,
                  Warri; he earned his medical degree from the University of
                  Nigeria, Nsukka; and a master’s degree at the University of
                  Lagos.
                </p>
                <p>He has an interest in General Medicine.</p>
              </div>
            </div>
          </div>
        </div>
