...
<html lang="en">
  <head>
    <title>Mr. George Chidozie Aham - Management Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/management-team/George-C.-Aham.jpg"
            alt="George-C.-Aham"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Mr. George Chidozie Aham</h2>
            <h4 class="navy-blue">Client Relations Manager</h4>

            <div class="icon-contact-number flex navy-blue">
              <i class="fa fa-phone-alt"></i>
              <p>+234 (0) 807 704 0127</p>
            </div>
            ...
            <ul class="inline-block-breadcrumb subnavbar-color">
              ...
              <li>
                <a href="../../../why-choose-us/our-team/management-team.html"
                  >Management-team</a
                >
              </li>
              <li>George Aham</li>
          ...
          <div class="flex">
            ...
            <div class="column-left col-30">
              <div class="profile-detail-wrapper">
                ...
                <div class="margin-bottom">
                  ...
                  <ul>
                    <li>Bsc Animal & Environmental Biology</li>
                  </ul>
                </div>
                <div class="margin-bottom">
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  He is the Client Relations Manager at Westend Hospital, Warri.
                  His job responsibility cuts across every aspect of the
                  operations of the Hospital, He is responsible for the
                  recruitment of new customers/ clients, day-to-day management
                  of the customers/clients and consistently launching severe
                  Customer Retention programs that ensure the customers/clients
                  always choose Westend Hospital. His major clients are
                  cooperate organizations that have chosen Westend because of
                  his persistence, exceptional customer retention, and
                  problem-solving skills. He is also skilled in negotiation,
                  conflict resolution, and team building.
                </p>
                <p>
                  George has been able to merge Public Health Awareness Programs
                  with his original role of Client Relations creating a
                  formidable tool for Customer/Client Recruitment. His Public
                  Health Awareness Programs have been felt in most cooperate
                  organizations, Radio Stations, and market Places in Warri and
                  its environs. He is a natural leader, a motivator, and a
                  solution provider in Customer/Client Relations.
                </p>
              </div>
            </div>
          </div>
