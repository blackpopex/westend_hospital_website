...
<html lang="en">
  <head>
    <title>Pharm. Johnny Amadasun - Management Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <meta
      name="description"
      content=" He is the chairman Westend Hospital, Safari Pharmacy, Cool Running Laboratory and Chairman of the board, Father's Heart Childrens Trust."
    />
    <meta charset="UTF-8" />
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/management-team/Johnny-Amadasun.jpg"
            alt="Johnny Amadasun"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Pharm. John N. O. Amadasun</h2>
            <h4 class="navy-blue">Chairman</h4>

            <div class="icon-contact-number flex navy-blue"></div>
          ...
          <div class="flex">
              ...
              <div class="profile-detail-wrapper">
                ...
                <div class="margin-bottom">
                  ...
                  <ul>
                    ...
                    <li>MPSN</li>
                    <li>MFIP</li>
                    <li>MBA Project Management (Wales)</li>
                  </ul>
                </div>
                <div class="margin-bottom">
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  He is the Managing Director of Westend Hospital, Safari
                  Pharmacy, Cool Running Laboratory and Chairman of the board,
                  Father's Heart Childrens Trust.
                </p>
                <p>
                  An Experienced professional with a demonstrated history of
                  working in the healthcare and pharmaceutical industry. Skilled
                  in negotiation, pharmaceutics, hospital management, pharma
                  retail and wholesaling and brand creation. Strong professional
                  with a Bachelors in Pharmacy and an MBA focused in Project
                  Managment from University of Wales, Cardiff.
                </p>
              </div>
            </div>
          </div>
