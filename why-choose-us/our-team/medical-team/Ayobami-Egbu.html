...
<html lang="en">
  <head>
    <title>Dr. Ayobami Egbu - Medical Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <meta
      name="description"
      content="A Consultant physician, Dermatologist and benerologist who specializes in conditions affecting the skin, hair, nails and the treatment of sexually transmitted diseases. She obtained her Bachelor of Medicine, Bachelor of Surgery (MB;BS) degree from the college of Medicine, University of Ibadan."
    />
    <meta charset="UTF-8" />
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/medical-team/Ayobami-Egbu.jpg"
            alt="Dr. Ayobami Egbu"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Dr. Ayobami Egbu</h2>
            <h4 class="navy-blue">Consultant Dermatologist & Venereologist</h4>
          ...
          <div class="flex">
            ...
            <div class="column-left col-30">
              <div class="profile-detail-wrapper">
                ...
                <div class="margin-bottom">
                  ...
                  <ul>
                    <li>Bachelor of Medicine (MB)</li>
                    <li>Bachelor of Surgery (BS)</li>
                    <li>West African College of Physicians (FWACP)</li>
                    <li>
                      MSc in Physiology (Cardiovascular and Respiratory
                      Physiology)
                    </li>
                  </ul>
                </div>
                <div class="margin-bottom">
                  ...
                  <ul>
                    <li>Nigerian Medical Association (NMA)</li>
                    <li>Nigerian Association of Dermatologists (NAD)</li>
                  </ul>
                </div>
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  Dr Ayobami Egbu is a Consultant Physician, Dermatologist and
                  Venereologist who specializes in conditions affecting the
                  skin, hair, nails and the treatment of sexually transmitted
                  diseases.
                </p>
                <p>
                  She obtained her Bachelor of Medicine; Bachelor of Surgery
                  (MB;BS) degree from the College of Medicine, University of
                  Ibadan.
                </p>
                <p>
                  She underwent residency training in the Department of
                  Medicine; University College Hospital, Ibadan after which she
                  obtained the Fellowship of the West African College of
                  Physicians (FWACP) in the Faculty of Internal Medicine.
                </p>
                <p>
                  She obtained a certificate from the University of Washington
                  after completing a course in Leadership and Management in
                  health in 2015. She won the award for resident of the year
                  from the Association of Resident Doctors, University College
                  Hospital, Ibadan in 2016. She also received the ISD Global
                  Education Award from the International Society of Dermatology
                  in 2017.
                </p>
                <p>
                  She has a masters degree in Physiology (Cardiovascular and
                  Respiratory Physiology) from the University of Ibadan.
                </p>
                <p>
                  She is a member of the Nigerian Medical Association (NMA),
