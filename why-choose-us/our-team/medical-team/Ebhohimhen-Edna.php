...
<html lang="en">
  <head>
    <title>Scientist Ebhohimhen-Edna - Medical Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/medical-team/Ebhohimhen-Edna.jpg"
            alt="Ebhohimhen-Edna"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Mrs. Ebhohimhen-Edna</h2>
            <h4 class="navy-blue">Head of Laboratory Department</h4>

            <div class="icon-contact-number flex navy-blue">
              <i class="fa fa-phone-alt"></i>
              <p>+234 (0) 807 734 4979</p>
            </div>
          ...
          <div class="flex">
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  She is the department head of the Laboratory at Westend
                  Hospital. A medical laboratory scientist from the University
                  of Benin, with over 19 years of experience in laboratory
                  practice, serving in several private and public hospitals.
                </p>
                <p>
                  She completed her NYSC Programme at Hadejia General Hospital
                  Jigawa State in 1999.
                </p>
                <p>
                  She holds an M.sc in Medical Microbiology from the University
                  of Benin and has also attended several training programs and
                  workshops in HIV and PMTCT both in Nigeria and Malawi.
                </p>
              </div>
            </div>
          </div>
