                      ...
                      ></div>
                                ...
                                <div id="searchResult" class="popular-searches">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="../../../medical-test-and-services/A-Z-of-all-medical-services.html">Services</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <main>
            <div class="section-background-image staff-profile">
                <div class="container flex profile-header">
                    <img src="../../../img/team-members/profile-photo/medical-team/Helen-Okpue.jpg" alt="Helen-Okpue" id="staffImg">
                    <div class="staff-profile-details">
                        ...
                        <ul class="inline-block-breadcrumb subnavbar-color">
                            ...
                            <li>
                                <a href="../../../why-choose-us/our-team/medical-team.html">medical-team</a>
                            </li>
                            <li>Helen Okpue</li>
                        </ul>
                    </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="margin-bottom">
                                ...
                                <p>An enthusiastic, compassionate, and devoted professional with extensive experience across all areas of healthcare provision and management. She is a highly experienced and exceptional leader who can develop and motivate others to achieve targets, upholds healthcare standards, and demonstrates a strong ability as a team leader with good listening skills.</p>
                                <p>She is a proactive individual, able to adapt and perform effectively under pressure. Amiable with good interpersonal relationships with superiors, colleagues, subordinates, patients, and relatives.</p>
                                 <p>She is also diligent and goes the extra mile to achieve set goals, quick to learn with good interpersonal and organizational ethics; with the believes that it pays to work hard.</p>

                                 <div class="margin-top">
                                    <h6 class="navy-blue">Her duties include: </h6>
                                    <ul class="square-list-type margin-bottom" id="squareList">
                                            <li>Coordinating the day-to-day activities of the hospital making sure that cost-effective healthcare is rendered to all categories of patients.</li>
                                            <li>Implementing the care plan and evaluating care rendered to clients as per hospital policy.</li>
                                            <li>Allocating staff to various units according to their strength and ability.</li>
                                            <li>Planning and budgeting for consumables and instruments as per the need of the hospital.</li>
                                            ...
                                            <li>Ensuring that the equipments are functional and the faulty ones are reported for repairs.</li>
                                 </div>
                            </div>                     
                        </div>
                    </div>
                    ...
                    <div class="flex lg-size">
                        ...
                        <div>
                            ...
                            <div class="ways-to-help footer-header">
                                ...
                                <a href="../../../patient-and-visitors/online-pay.html" class="make-donation btn rounded-white-btn">Make a Donation</a>
                            </div>
                        </div>
                    </div>
                    <div
