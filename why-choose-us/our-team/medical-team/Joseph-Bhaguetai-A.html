...
<html lang="en">
  <head>
    <title>
      Scientist Joseph Bhaguetai Aghawegbehe - Medical Team | Westend Hospital
    </title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <meta
      name="description"
      content="Our uniqueness begins with our team, we work as one so that we can achieve a common goal. "
    />
    <meta charset="UTF-8" />
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/medical-team/Joseph-Bhaguetai-A.jpg"
            alt="Joseph-Bhaguetai-A."
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Mr. Joseph Bhaguetai A.</h2>
            <h4 class="navy-blue">Molecular Laboratory Supervisor</h4>

            <div class="icon-contact-number flex navy-blue">
              <i class="fa fa-phone-alt"></i>
              <p>+234 (0) 807 737 2446</p>
            </div>
            ...
            <ul class="inline-block-breadcrumb subnavbar-color">
              ...
              <li>
                <a href="../../../why-choose-us/our-team/medical-team.html"
                  >medical-team</a
                >
              </li>
              <li>Joseph Bhaguetai A.</li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div class="flex">
            ...
            <div class="column-left col-30">
              <div class="profile-detail-wrapper">
                ...
                <div class="margin-bottom">
                  ...
                  <ul>
                    <li>Molecular and Clinical Chemistry</li>
                  </ul>
                </div>
                <div class="margin-bottom">
                  <h5 class="sky-blue">Qualification</h5>
                  <ul>
                    <li>BMLS, MSc. Medical Laboratory Science.</li>
                  </ul>
                </div>
                <div class="margin-bottom">
                  ...
                  <ul>
                    <li>
                      Associate member of Medical Laboratory Scientists of
                      Nigeria.
                    </li>
                  </ul>
                </div>
                <div class="margin-bottom">
                  <h5 class="sky-blue">License</h5>
                  <ul>
                    <li>Health and care professional council Uk.</li>
                    <li>Medical Laboratory Science Council of Nigeria.</li>
                  </ul>
                </div>
                <div class="margin-bottom">
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  A pioneer supervisor of Westend Hospital Molecular Laboratory.
                  The Westend Hospital Molecular laboratory unit was set up in
                  the year 2020 as the first private owned molecular laboratory
                  in Delta State in response to the global COVID-19 Pandemic for
                  the collection and analysis of COVID-19 samples as well as
                  COVID-19 case surveillance in partnership with Delta State
                  ministry of health and Nigeria Centre for Disease Control
                  (NCDC). Apart from COVID-19 analysis, other molecular testing
                  such as Hepatitis B and C, Human Papilloma Virus, etc. are
                  currently added to our routine analysis.
                </p>
                <p>
                  He coordinates DNA sample collection and processing for
                  paternity and maternity disputes, avuncular testing,
                  relatives, skin care, healthy weight, and food and pet
                  sensitivity DNA testing.
                </p>
                <p>
                  As a specialist Medical laboratory Scientist with over a
                  decade in Westend Hospital Laboratory Department, he has
                  served in various capacities such as Laboratory training
                  coordinator, where he coordinates training for new laboratory
                  staff and students on laboratory posting and restraining for
                  laboratory staff on good laboratory practices.
                </p>
                <p>
                  He also served as the Laboratory quality control and quality
                  assurance manager and laboratory safety offices.
                </p>
                <p>
                  He holds a bachelor’s degree in Medical Laboratory Science
                  from Ambrose Ali University and a master’s degree in Clinical
                  Chemistry from the University of Benin.
                </p>
              </div>
            </div>
          </div>
