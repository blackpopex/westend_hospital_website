...
<html lang="en">
  <head>
    <title>Ms. Okoh Chisom Favour - Medical Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/medical-team/Okoh-Chisom-Favour.jpg"
            alt="Okoh-Chisom-Favour"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Ms. Okoh Chisom Favour</h2>
            <h4 class="navy-blue">Head of Physiotherapy Department</h4>
          ...
          <div class="flex">
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  She has professional training and was licensed as a
                  Physiotherapist following her undergraduate degree at the
                  University of Nigeria where she was introduced to clinical
                  practice, research skills, critical reasoning, and the ability
                  to work ethically to meet the peculiar environments of the
                  hospital settings and clients' biopsychosocial needs.
                </p>
                <p>
                  She has a wide range of knowledge on different aspects of
                  physiotherapy ranging from Neurology, Orthopeadic,
                  Cardiopulmonary, exercise Immunology, Palliative care unit,
                  Pediatrics, Women's Health, and Geriatrics.
                </p>
                <p>
                  Currently, she has contributed to four publications in the
                  fields of physiotherapy, ergonomics, gerontology, and public
                  health and she seeks out every opportunity to learn and be
