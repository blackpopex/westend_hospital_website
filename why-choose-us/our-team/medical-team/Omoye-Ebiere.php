...
<html lang="en">
  <head>
    <title>Pharm. Omoye Ebiere - Medical Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/medical-team/Omoye Ebiere.jpg"
            alt="Omoye-Ebiere"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Pharm. Omoye Ebiere</h2>
            <h4 class="navy-blue">Head of Pharmacy Department</h4>

            <div class="icon-contact-number flex navy-blue">
              <i class="fa fa-phone-alt"></i>
              <p>+234 (0) 807 420 3064</p>
            </div>
          ...
          <div class="flex">
            ...
            <div class="column-left col-30">
              <div class="profile-detail-wrapper">
                ...
                <div class="margin-bottom">
                  ...
                  <ul>
                    <li>B.Pharm. Pharm D.</li>
                  </ul>
                </div>
                <div class="margin-bottom">
                  <h5 class="sky-blue">Memberships</h5>
                  <ul>
                    <li>Pharmacist society of Nigeria (PSN).</li>
                    <li>Clinical pharmacists of Nigeria.</li>
                    <li>
                      Association of hospital and administrative pharmacists of
                      Nigeria (AHAPN).
                    </li>
                  </ul>
                </div>
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  A licensed clinical pharmacist responsible for the daily
                  operations in the pharmacy department of Westend Hospital,
                  Warri. She ensures that medications prescribed for patients
                  contribute to better health outcomes.
                </p>
                <p>
                  Her duties include lecturing pharmacy students on clinical
                  practice as regards pharmaceutical care – which is
                  patient-centered.
                </p>
                <p>
                  She holds a Bachelor of Pharmacy degree and a doctor of
                  pharmacy degree from the University of Benin, Edo State,
                  Nigeria. She’s is a full-time member of the pharmacist society
                  of Nigeria (PSN) for decades, others include the clinical
                  pharmacists of Nigeria, and the Association of hospital and
