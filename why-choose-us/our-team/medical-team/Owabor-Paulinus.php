...
<html lang="en">
  <head>
    <title>Dr. Owabor Paulinus - Medical Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/medical-team/Owabor-Paulinus.jpg"
            alt="Owabor-Paulinus"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Dr. Owabor Paulinus</h2>
            <h4 class="navy-blue">Consultant Obstetrician and Gynaecologist</h4>
          ...
          <div class="flex">
              ...
              <div class="profile-detail-wrapper">
                ...
                <div class="margin-bottom">
                  ...
                  <ul>
                    ...
                    <li>Consultant Obstetrics & Gynaecology</li>
                  </ul>
                </div>
                <div class="margin-bottom">
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  He is an Obstetrician and Gynaecologist and had his basic
                  medical education (MBBS) at the University of Benin, Benin
                  City. His post-graduate training was all at the university of
                  Benin teaching hospital Benin City to become a consultant in
                  Obstetrics and Gynaecologist.
                </p>
                <p>
                  As an Obstetrician he has a passion for fetomaternal medicine,
                  ensuring that every pregnant woman has a healthy and safe
                  delivery.
                </p>
              </div>
            </div>
