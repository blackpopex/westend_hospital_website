...
<html lang="en">
  <head>
    <title>Nurse Rita Omonagoma - Medical Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/medical-team/Rita-Omonagoma.jpg"
            alt="Rita-Omonagoma"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Mrs. Rita Omonagoma</h2>
            <h4 class="navy-blue">Deputy Matron Nursing Department</h4>
          ...
          <div class="flex">
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  Rita Omonagoma is a Paediatric Nurse at Westend Hospital. She
                  holds RNPAE at the School of Post Basic Nursing University of
                  Ilorin Teaching Hospital Kwara State and an RN at the Baptist
                  School of Nursing Eku Delta State. As RNPAE/ RN, she has a
                  passion for well being of children both sick and healthy.
                </p>
                <p>
                  She Advocates for children involving the parent in their
                  health care and educates parents about child health conditions
                  and the benefit of Nutrition. She works with other health
                  professionals to obtain optimal health care for children.
                </p>
              </div>
            </div>
          </div>
