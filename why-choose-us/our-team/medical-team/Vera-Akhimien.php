...
<html lang="en">
  <head>
    <title>Nurse Vera Akhimien - Medical Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
    ...
    <main>
      <div class="section-background-image staff-profile">
        <div class="container flex profile-header">
          <img
            src="../../../img/team-members/profile-photo/medical-team/Vera-Akhimien.jpg"
            alt="Vera-Akhimien"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Mrs. Vera Akhimien</h2>
            <h4 class="navy-blue">Matron Nursing Department</h4>

            <div class="icon-contact-number flex navy-blue">
              <i class="fa fa-phone-alt"></i>
              <p>+234 (0) 807 420 3365</p>
            </div>
          ...
          <div class="flex">
            ...
            <div class="column-right col-70">
              ...
              <div class="margin-bottom">
                ...
                <p>
                  She is currently the matron of Westend Hospital Warri, she is
                  a registered Nurse, and midwife, and has served the hospital
                  in varying capacities for over 2 decades. Her duties as a
                  matron are to oversee the affairs of the nursing department,
                  and ante and post-natal services. She also oversees delivery
                  and family planning services.
                </p>
                <p>
                  She is a dedicated, heart-loving, efficient, and focused
                  individual. Over the years she has served the hospital
                  genuinely and stopped at nothing other than giving her best to
                  see the growth of the establishment.
                </p>
                <p>
                  She ensures admitted patients are properly cared for and
                  adequate timing for routine medications is well followed.
                </p>
                <p>
                  Professional skills includes Basic Life Support (BLS) and
                  Reproductive Health.
                </p>
              </div>
            </div>
