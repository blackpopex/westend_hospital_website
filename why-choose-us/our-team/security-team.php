...
<html lang="en">
  <head>
    <title>Security Team | Westend Hospital</title>
    <link
      rel="icon"
      type="image/x-icon"
  ...
  <body>
    ...
    <main>
      <div class="section-background-image out-team">
        <div class="container">
          <h2 class="subnavbar-color">Security Team</h2>
        ...
        <div class="container align-start column-reverse">
          <div class="flex">
                  ...
                  <div class="quick-links">
                    <div>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="./security-team.html">Security Team</a>
                        </li>
                      </ul>
                    </div>
                    <div>
            ...
            <div class="column-right col-70">
              <div>
                <h3 class="navy-blue">Security Team</h3>
                <p>
                  Find out what it is really like to work at Westend Hospitals
                  from those who know best – our staff. The profiles below will
                  give you an insight into what life is like working in one of
                  Nigeria’s best hospitals.
                </p>
                ...
                <div class="article-container flex">
                  ...
                  <div class="profile article-box col-30">
                    ...
                    <div class="title transparent-sky-blue">
                      <h4>Mr. Anthony I. Ohiri</h4>
                    </div>
                    <div class="article-content lighter-blue-bg">
                      <h6 class="navy-blue">Chief Security Officer</h6>
                      <p>
                        He hails from Umukpo-Okenne in Ohoba of Ohajil Egbema
                        Local...
                      </p>
                      <a
                        href="./security-team/Anthony-Ohiri.html"
