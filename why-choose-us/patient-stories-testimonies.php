        ...
        <main>
            ...
            <section id="patient-stories">
                ...
                <div class="flex">
                    ...
                    <p>We can tell you all about our core values of caring for people with compassion, excellence and teamwork. But nobody can tell it better than our patients. Here are just a few stories from our patients. In these stories you'll have a glimpse of what Westend Hospital is all about.</p>
                    <p>Do you have a story to share ? visit
                        <a href="../patient-feedback.html" class="sky-blue">feedback</a>.</p>
                    <!--patient stories-->
                    <div class="col-100">
                        <div>
                            <div class="article-container flex">
                                ...
                                <!--Myria Mack-Williams story-->
                                    <div class="profile article-box col-30"> <img src="../img/testimonials/ogaga-siakpere.jpg" alt="Ogaga Siakpere">
                                    <div class="title transparent-sky-blue">
                                        <h4>Mr. Ogaga Siakpere</h4>
                                    </div>
                                    <div class="story article-content lighter-blue-bg">
                                        <p>I was born here in Westend Hospital 4th March, 1985, then it used to be the best...</p>
                                        <a href="testimonies/ogaga-siakpere.html" class="sky-blue float-right">Read story
                                ...
                                <div class="profile article-box col-30">
                                    ...
                                    <div class="story article-content lighter-blue-bg">
                                        <p>Westend Hospital is the best place I have ever been to as an expectant mum. I ...</p>
                                        <a href="testimonies/elohor-tarila.html" class="sky-blue float-right">Read story
                                            <i class="fa fa-angle-right"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="profile article-box col-30">
                                    ...
                                    <div class="story article-content lighter-blue-bg">
                                        <p>It was really something I didn't expect because I felt all hospital staff...</p>
                                        <a href="testimonies/isioma.html" class="sky-blue float-right">Read story
                                            <i class="fa fa-angle-right"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="profile article-box col-30">
                                    ...
                                    <div class="story article-content lighter-blue-bg">
                                        <p>Having my kids at Westend was an experience out of this world, that...</p>
                                        <a href="testimonies/akan-edem.html" class="sky-blue float-right">Read story
                                            <i class="fa fa-angle-right"></i>
                                        </a>
                                    </div>
                                </div>
