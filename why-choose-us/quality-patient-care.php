...
<html lang="en">
    <head>
        <title>
           Quality of Patient Care | Westend Hospital
        </title>
        <link rel="icon" type="image/x-icon" href="../img/logo/favicon.ico.png"/>
        <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css"/>
        <meta name="description" content="The degree to which health services for individuals and populations boost the likelihood of desired health outcomes is how Westend Hospital defines quality. The best and highest quality of treatment for our patients is our top focus since patients and their families can tell when a service is of high caliber."/>
        <meta charset="UTF-8"/>
            ...
            <section id="quality-of-patient-care">
                ...
                <div class="flex">
                            ...
                            <div class="column-left">
                                ...
                                <div class="quick-links">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="our-mission-vision-and-values.html">Our Mission, Vision & Values</a>
                                        </li>
                                        <li>
                                            <a href="quality-patient-care.html">Quality Patient Care</a>
                                        </li>
                                        <li>
                                            <a href="patient-stories-testimonies.html">Patient Stories/Testimonies</a>
                                        </li>
                                        <li>
                    ...
                    <div class="margin-bottom">
                        ...
                        <h3 class="navy-blue">Our patient, our priority</h3>
                        <p>Our goal as a hospital is providing the optimum and highest quality care to our patients. At Westend Hospital, we define quality as the <b>degree to which health services for individuals and populations increase the likelihood of desired health outcomes</b>. Patients and their relatives know quality care when they experience it. These includes but not limited to a nurse's response time, a doctor's bedside manner, the hospital's atmosphere—all of these things affect how people feel about the quality of their healthcare.</p>

                        <p>
                            Westend Hospital defines optimal quality care as:
                        </p>
                          <ul class="square-list-type margin-bottom" id="squareList">
                            <li>Remarkable patient safety.</li>
                            <li>Quick turnaround time in delivering healthcare.</li>
                            <li>Higher-ranking care.</li>
                            <li>Impartial access to healthcare.</li>
                        </ul>

                        <p>While delivering quality patient care we strive to ensure it is </p>
