        ...
        <main>
            <div class="section-background-image staff-profile" id="testimonies">
                <div class="container flex profile-header">
                    <img src="../../img/testimonials/testifiers-profile/elohor-tarila.jpg" alt="Elohor Tarila"
                        id="staffImg" />
                    <div class="staff-profile-details">
                        ...
                        <ul class="inline-block-breadcrumb subnavbar-color">
                            ...
                            <li>
                                <a href="../patient-stories-testimonies">patient stories</a>
                            </li>
                            <li>Elohor Tarila</li>
                        </ul>
                    </div>
                        ...
                        <div class="column-right col-70">
                            ...
                            <div class="margin-bottom">
                                <div class="testimonies-wrapper">
                                    <div class="flex align-start" style="flex-direction: row; margin-top: 0">
                                        <iconify-icon icon="bi:quote" id="iconify-testify" class="iconify-large-text">
                                        </iconify-icon>
                                        <div>
