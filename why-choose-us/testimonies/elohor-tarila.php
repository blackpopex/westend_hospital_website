...
<html lang="en">
  <head>
    <title>Westend Hospital | Elohor Tarila</title>
    <link
      rel="icon"
      type="image/x-icon"
  ...
  <body>
    ...
    <!---------------------------MAIN PAGE CONTENT---------------------------------------------->
    <main>
      <div class="section-background-image staff-profile" id="testimonies">
        <div class="container flex profile-header">
          <img
            src="../../img/testimonials/testifiers-profile/elohor-tarila.jpg"
            alt="Elohor Tarila"
            id="staffImg"
          />
          <div class="staff-profile-details">
            <h2 class="subnavbar-color">Mrs. Elohor Tarila</h2>
              ...
              <div class="margin-bottom">
                <div class="testimonies-wrapper">
                  <div
                    ...
                    style="flex-direction: row; margin-top: 0"
                  >
                    <iconify-icon
                      icon="bi:quote"
                      id="iconify-testify"
                      class="iconify-large-text"
                    ></iconify-icon>
                    <div>
                      <h5 class="testimonies-text">
                        Westend Hospital is the best place I have ever been to
                        as an expectant mum. I can't forget the good treatment.
                        As a first-time mum, I wanted to ask all the questions
                        in the world about my growing baby and all I am to
                        expect. Thank God I choose Westend Hospital because all
                        my questions were answered by my assigned gynecologist.
                        I was happy and I felt peace all the way. My health was
                        their major priority and they always want to see that
                        you and your baby are healthy. What more can I say,
                        Westend Hospital is the best.
                      </h5>
                      <div class="testify-info margin-top">
                        <h3 class="navy-blue small-h3 text-right">
                          Mrs. Elohor Tarila
                        </h3>
                        <h6 class="sky-blue testified-date text-right">
                          June 5, 2021
                        </h6>
                      </div>
                    </div>
